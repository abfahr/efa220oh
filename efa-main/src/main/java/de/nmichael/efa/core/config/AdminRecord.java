...
public class AdminRecord extends DataRecord implements IItemListener {
  ...
  public static void initialize() {
    ...
    f.add(PASSWORD);
    t.add(IDataAccess.DATA_PASSWORDH);
    f.add(EMAIL);
    t.add(IDataAccess.DATA_STRING);
    f.add(EDITADMINS);
    ...
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(EDITBOATRESERVATION);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(EDITBOATDAMAGES);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(EDITBOATS);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(EDITPERSONS);
    ...
    f.add(MSGREADADMIN);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(MSGREADBOATMAINT);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(MSGMARKREADADMIN);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(MSGMARKREADBOATMAINT);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(MSGAUTOREADADMIN);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(MSGAUTOREADBOATMAINT);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(EDITSTATISTICS);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(ADVANCEDEDIT);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(REMOTEACCESS);
  ...
  public boolean isRemoteAdminRecord() {
    return isRemoteAdmin
        || this.getPersistence().data().getStorageType() == IDataAccess.TYPE_EFA_REMOTE;
  }
  ...
  public Vector<IItemType> getGuiItems(AdminRecord admin) {
    ...
    ((ItemTypeBoolean) item).setEnabled(false); // no one can ever change this: Super-Admin is
    // always allowed, all others are not
    ...
    v.add(item = new ItemTypeBoolean(MSGREADADMIN, isAllowedMsgReadAdmin(),
        IItemType.TYPE_PUBLIC, CAT_MESSAGES, International.getMessage(
            "Nachrichten an {recipient} lesen",
            International.getString("Admin"))));
    ((ItemTypeBoolean) item).setEnabled(!isSuperAdmin());
    v.add(item = new ItemTypeBoolean(MSGMARKREADADMIN, isAllowedMsgMarkReadAdmin(),
        IItemType.TYPE_PUBLIC, CAT_MESSAGES, International.getMessage(
            "Nachrichten an {recipient} als gelesen markieren",
            International.getString("Admin"))));
    ((ItemTypeBoolean) item).setEnabled(!isSuperAdmin());
    v.add(item = new ItemTypeBoolean(MSGAUTOREADADMIN, isAllowedMsgAutoMarkReadAdmin(),
        IItemType.TYPE_PUBLIC, CAT_MESSAGES, International.getMessage(
            "Nachrichten an {recipient} automatisch als gelesen markieren",
            International.getString("Admin"))));
    ...
    v.add(item = new ItemTypeBoolean(MSGMARKREADBOATMAINT, isAllowedMsgMarkReadBoatMaintenance(),
        IItemType.TYPE_PUBLIC, CAT_MESSAGES, International.getMessage(
            ...
            International.getString("Bootswart"))));
    ((ItemTypeBoolean) item).setEnabled(!isSuperAdmin());
    v.add(item = new ItemTypeBoolean(MSGAUTOREADBOATMAINT,
        isAllowedMsgAutoMarkReadBoatMaintenance(),
        IItemType.TYPE_PUBLIC, CAT_MESSAGES, International.getMessage(
            "Nachrichten an {recipient} automatisch als gelesen markieren",
            International.getString("Bootswart"))));
    return v;
