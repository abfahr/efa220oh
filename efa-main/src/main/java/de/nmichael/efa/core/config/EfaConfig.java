...
public class  EfaConfig extends StorageObject implements IItemFactory {
  ...
  public final String CATEGORY_NOTIFICATIONS = "%13%"
      + International.getString("Benachrichtigungen");
  ...
  public final String CATEGORY_LOCALE = "%17%"
      + International.getStringWithoutAnyEscaping("Sprache & Region");
  ...
  public EfaConfig(int storageType,
    ...
    super(storageType, storageLocation, storageUsername, storagePassword, "configuration",
        DATATYPE, International.getString("Konfiguration"));
    initialize(null);
  }
  ...
  private void iniParameters(CustSettings custSettings) {
    synchronized (configValues) {
      ...
      addParameter(version = new ItemTypeString("EfaVersion", "100",
          ...
          "efa version"));
      addParameter(efaVersionLastCheck = new ItemTypeLong("EfaVersionLastCheck", 0, 0,
          Long.MAX_VALUE,
          IItemType.TYPE_INTERNAL, BaseTabbedDialog.makeCategory(CATEGORY_INTERNAL),
      ...
      addParameter(registrationChecks = new ItemTypeInteger("EfaRegistrationChecks", 0, 0,
          Integer.MAX_VALUE, false,
          IItemType.TYPE_INTERNAL, BaseTabbedDialog.makeCategory(CATEGORY_INTERNAL),
          "efa registration checks counter"));
      addParameter(efaBoathouseChangeLogbookReminder = new ItemTypeString(
          "EfaBoathouseChangeLogbookReminder", "",
          IItemType.TYPE_INTERNAL, BaseTabbedDialog.makeCategory(CATEGORY_INTERNAL),
      ...
      addParameter(showDestinationInfoForInput = new ItemTypeBoolean("DestinationInfoShowForInput",
          false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_INPUT),
      ...
      addParameter(prefixDestinationWithWaters = new ItemTypeBoolean("PrefixDestinationWithWaters",
          false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_INPUT),
          International.getString("Gewässernamen in Zielliste anzeigen")));
      addParameter(postfixPersonsWithClubName = new ItemTypeBoolean("PostfixPersonsWithClubName",
          false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_INPUT),
      ...
      addParameter(autogenAlias = new ItemTypeBoolean("InputShortcutAutoGenerate", false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_INPUT),
          International
              .getString("Eingabe-Kürzel automatisch beim Anlegen neuer Mitglieder generieren")));
      ...
      addParameter(windowXOffset = new ItemTypeInteger("WindowOffsetX", 0, Integer.MIN_VALUE,
          Integer.MAX_VALUE, false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_GUI),
          International.getString("Fenster-Offset") + " X"
              + " (" + International.getString("Pixel") + ")"));
      addParameter(windowYOffset = new ItemTypeInteger("WindowOffsetY", 0, Integer.MIN_VALUE,
          Integer.MAX_VALUE, false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_GUI),
          International.getString("Fenster-Offset") + " Y"
              + " (" + International.getString("Pixel") + ")"));
      addParameter(screenWidth = new ItemTypeInteger("WindowScreenWidth", 0, 0, Integer.MAX_VALUE,
          false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_GUI),
          International.getString("Bildschirmbreite")
              + " (" + International.getString("Pixel") + ")"));
      addParameter(screenHeight = new ItemTypeInteger("WindowScreenHeight", 0, 0,
          Integer.MAX_VALUE, false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_GUI),
      ...
      addParameter(maxDialogWidth = new ItemTypeInteger("WindowDialogMaxWidth", 0, 0,
          ...
          International.getString("maximale Dialog-Breite")
              + " (" + International.getString("Pixel") + ")"));
      addParameter(maxDialogHeight = new ItemTypeInteger("WindowDialogMaxHeight", 0, 0,
          Integer.MAX_VALUE, false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_GUI),
      ...
      // ============================= COMMON:EXTTOOLS =============================
      addParameter(browser = new ItemTypeFile("ProgramWebbrowser",
          searchForProgram(DEFAULT_BROWSER),
          ...
          International.getString("Webbrowser")));
      addParameter(acrobat = new ItemTypeFile("ProgramAcrobatReader",
          searchForProgram(DEFAULT_ACROBAT),
      ...
      // ============================= COMMON:PRINT =============================
      addParameter(printPageWidth = new ItemTypeInteger("PrintPageWidth", 210, 1,
          Integer.MAX_VALUE, false,
      ...
      addParameter(printPageHeight = new ItemTypeInteger("PrintPageHeight", 297, 1,
          Integer.MAX_VALUE, false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_PRINTING),
          International.getString("Seitenhöhe")));
      addParameter(printLeftMargin = new ItemTypeInteger("PrintPageMarginLeftRight", 15, 0,
          Integer.MAX_VALUE, false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_PRINTING),
          International.getString("linker und rechter Rand")));
      addParameter(printTopMargin = new ItemTypeInteger("PrintPageMarginTopBottom", 15, 0,
          Integer.MAX_VALUE, false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_PRINTING),
          International.getString("oberer und unterer Rand")));
      addParameter(printPageOverlap = new ItemTypeInteger("PrintPageOverlap", 5, 0,
          Integer.MAX_VALUE, false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_COMMON, CATEGORY_PRINTING),
      ...
      addParameter(efaDirekt_listAllowToggleBoatsPersons = new ItemTypeBoolean(
          "BoatListToggleToPersons", false,
      ...
      addParameter(efaDirekt_listAllowToggleSortByCategories = new ItemTypeBoolean(
          "efaDirekt_listAllowToggleSortByCategories", false,
          IItemType.TYPE_PUBLIC,
          BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_COMMON),
      ...
      addParameter(efaDirekt_resLookAheadTime = new ItemTypeInteger(
          ...
          International
              .getString(
                  "Bei Fahrtbeginn auf Reservierungen bis zu x Minuten in der Zukunft prüfen")));
      addParameter(efaDirekt_showBootsschadenButton = new ItemTypeBoolean(
          "BoatDamageEnableReporting", true,
          IItemType.TYPE_PUBLIC,
          BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_COMMON),
      ...
      addParameter(reservierungAnMitgliedMitKuerzelEmailen = new ItemTypeBoolean(
          ...
          International
              .getString(
                  "jede Reservierung an Mitglieder mit Kürzel emailen. Insert, Update, Delete")));
      ...
      addParameter(efaDirekt_lockEfaFromDatum = new ItemTypeDate("LockEfaFromDate",
          new DataTypeDate(-1, -1, -1),
          IItemType.TYPE_PUBLIC,
          BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_LOCKEFA),
          International.getString("efa sperren") + ": "
              + International.getString("Sperrung automatisch beginnen") + " ("
              + International.getString("Datum") + ")"));
      addParameter(efaDirekt_lockEfaFromZeit = new ItemTypeTime("LockEfaFromTime",
          new DataTypeTime(-1, -1, -1),
          IItemType.TYPE_PUBLIC,
          BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_LOCKEFA),
          International.getString("efa sperren") + ": "
              + International.getString("Sperrung automatisch beginnen") + " ("
              + International.getString("Zeit") + ")"));
      addParameter(efaDirekt_lockEfaUntilDatum = new ItemTypeDate("LockEfaToDate",
          new DataTypeDate(-1, -1, -1),
          IItemType.TYPE_PUBLIC,
          BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_LOCKEFA),
          International.getString("efa sperren") + ": "
              ...
              + International.getString("Datum") + ")"));
      addParameter(efaDirekt_lockEfaUntilZeit = new ItemTypeTime("LockEfaToTime", new DataTypeTime(
          -1, -1, -1),
          IItemType.TYPE_PUBLIC,
          BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_LOCKEFA),
          International.getString("efa sperren") + ": "
      ...
      addParameter(efadirekt_lastBoatDamangeReminder = new ItemTypeLong("LastBoatDamageReminder",
          0,
          0, Long.MAX_VALUE,
          IItemType.TYPE_INTERNAL, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_COMMON),
      ...
      // ============================= BOATHOUSE:INPUT =============================
      addParameter(efaBoathouseOnlyEnterKnownBoats = new ItemTypeBoolean(
          "InputAllowOnlyKnownBoats", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_INPUT),
          International.getMessage(
              "Beim Eintrag von Fahrten nur bekannte Namen erlauben für {type}",
              International.getString("Boote"))));
      addParameter(efaBoathouseOnlyEnterKnownPersons = new ItemTypeBoolean(
          "InputAllowOnlyKnownPersons", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_INPUT),
          International.getMessage(
              "Beim Eintrag von Fahrten nur bekannte Namen erlauben für {type}",
              International.getString("Personen"))));
      addParameter(efaBoathouseOnlyEnterKnownDestinations = new ItemTypeBoolean(
          "InputAllowOnlyKnownDestinatins", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_INPUT),
          International.getMessage(
              "Beim Eintrag von Fahrten nur bekannte Namen erlauben für {type}",
              International.getString("Ziele"))));
      addParameter(efaBoathouseOnlyEnterKnownWaters = new ItemTypeBoolean(
          "InputAllowOnlyKnownWaters", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_INPUT),
          International.getMessage(
              "Beim Eintrag von Fahrten nur bekannte Namen erlauben für {type}",
              International.getString("Gewässer"))));
      addParameter(efaDirekt_checkAllowedGroupsForBoat = new ItemTypeBoolean(
          "InputCheckAllowedPersonsInBoat", true,
      ...
      addParameter(efaDirekt_checkAllowedMinGroupForBoat = new ItemTypeBoolean(
          "InputCheckMinGroupPersonsInBoat",
          true,
          IItemType.TYPE_EXPERT,
      ...
      addParameter(efaDirekt_eintragErlaubeNurMaxRudererzahl = new ItemTypeBoolean(
          "InputAllowOnlyMaxCrewNumber", true,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_INPUT),
          International
              .getString("Nur für das Boot maximal mögliche Anzahl an Personen erlauben")));
      addParameter(efaDirekt_eintragErzwingeObmann = new ItemTypeBoolean(
          "InputMustSelectBoatCaptain", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_INPUT),
          International.getString("Obmann muß ausgewählt werden")));
      addParameter(efaDirekt_eintragNichtAenderbarUhrzeit = new ItemTypeBoolean(
          "InputNotEditableTime", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_INPUT),
      ...
      addParameter(efaDirekt_minusMinutenAnkunft = new ItemTypeInteger(
          "FinishSessionTimeSubstract", 5, 0, Integer.MAX_VALUE, false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_INPUT),
      ...
      addParameter(efaDirekt_zielBeiFahrtbeginnPflicht = new ItemTypeBoolean(
          "StartSessionMustSelectDestination", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_INPUT),
      ...
      addParameter(efaDirekt_gewaesserBeiUnbekanntenZielenPflicht = new ItemTypeBoolean(
          "MustEnterWatersForUnknownDestinations", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_INPUT),
          International.getString("Gewässer muß bei unbekannten Zielen angegeben werden")));
      addParameter(efaDirekt_eintragHideUnnecessaryInputFields = new ItemTypeBoolean(
          "InputHideUnnecessaryFields", true,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_INPUT),
      ...
      addParameter(efaDirekt_eintragNichtAenderbarKmBeiBekanntenZielen = new ItemTypeBoolean(
          ...
          BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_INPUT), International
              .getString(
                  "Vorgeschlagene Kilometer bei bekannten Zielen können nicht geändert werden")));
      ...
      addParameter(efaDirekt_fensterNichtVerschiebbar = new ItemTypeBoolean(
          "EfaBoathouseWindowFixedPosition", true,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_GUI),
          International.getString("Hauptfenster nicht verschiebbar")));
      addParameter(efaDirekt_immerImVordergrund = new ItemTypeBoolean(
          "EfaBoathouseWindowAlwaysOnTop", false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_GUI),
      ...
      addParameter(efaDirekt_immerImVordergrundBringToFront = new ItemTypeBoolean(
          "EfaBoathouseWindowAlwaysOnTopBringToFront", false,
      ...
      addParameter(efaDirekt_fontSize = new ItemTypeInteger("EfaBoathouseFontSize", 16, 6, 32,
          false,
      ...
      addParameter(efaDirekt_resBooteNichtVerfuegbar = new ItemTypeBoolean(
          "BoatListShowReservedBoatsAsNotAvailable", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_GUI),
      ...
      addParameter(efaDirekt_wafaRegattaBooteAufFahrtNichtVerfuegbar = new ItemTypeBoolean(
          "BoatListShowOnMultiDayOrRegattaBoatsAsNotAvailable",
          true,
          IItemType.TYPE_PUBLIC,
      ...
      addParameter(efaDirekt_showZielnameFuerBooteUnterwegs = new ItemTypeBoolean(
          "BoatListDisplayDestinationForBoatsOnTheWater", false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_GUI),
      ...
      addParameter(efaBoathouseShowLastFromWaterNotification = new ItemTypeBoolean(
          ...
          International
              .getString(
                  "Nach Beenden letzter Fahrt Erinnerung zum Schließen der Bootshalle anzeigen")));
      ...
      addParameter(efaDirekt_maxFBAnzeigenFahrten = new ItemTypeInteger(
          "LogbookDisplayEntriesMaxNumber", 100, 1, Integer.MAX_VALUE, false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_GUI),
          International.getString("Fahrtenbuch anzeigen") + ": "
              + International.getString("maximale Anzahl von Fahrten")));
      addParameter(efaDirekt_anzFBAnzeigenFahrten = new ItemTypeInteger(
          "LogbookDisplayEntriesDefaultNumber", 50, 1, Integer.MAX_VALUE, false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_GUI),
          International.getString("Fahrtenbuch anzeigen") + ": "
              + International.getString("Anzahl von Fahrten")));
      addParameter(efaDirekt_FBAnzeigenAuchUnvollstaendige = new ItemTypeBoolean(
          "LogbookDisplayEntriesDefaultAlsoIncomplete", false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_GUI),
          International.getString("Fahrtenbuch anzeigen") + ": "
              + International.getString("auch unvollständige Fahrten")));
      addParameter(efaDirekt_notificationWindowTimeout = new ItemTypeInteger(
          "NotificationWindowTimeout", 10, 0, Integer.MAX_VALUE,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE, CATEGORY_GUI),
      ...
      addParameter(efaDirekt_butBootsreservierungen = new ItemTypeConfigButton(
          "ButtonBoatReservations",
      ...
      addParameter(efaDirekt_butFahrtenbuchAnzeigen = new ItemTypeConfigButton("ButtonShowLogbook",
          ...
          International.getMessage("Button '{button}'",
              International.getString("Fahrtenbuch anzeigen"))));
      addParameter(efaDirekt_butStatistikErstellen = new ItemTypeConfigButton(
          "ButtonCreateStatistics",
      ...
      // ============================= BOATHOUSE:STARTSTOP =============================
      addParameter(efaDirekt_restartTime = new ItemTypeTime("EfaExitRestartTime", new DataTypeTime(
          4, 0, 0),
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_STARTSTOP),
          International.getString("Uhrzeit zum automatischen Neustart von efa")));
      addParameter(efaDirekt_exitTime = new ItemTypeTime("EfaExitExitTime", new DataTypeTime(-1,
          -1, -1),
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_STARTSTOP),
          International.getString("Uhrzeit zum automatischen Beenden von efa")));
      addParameter(efaDirekt_exitIdleTime = new ItemTypeInteger("EfaExitIdleTime",
          ItemTypeInteger.UNSET, 0, Integer.MAX_VALUE, true,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_STARTSTOP),
      ...
      addParameter(efaDirekt_execOnEfaAutoExit = new ItemTypeString("EfaExitExecOnAutoExit", "",
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_STARTSTOP),
          International
              .getString("Folgendes Kommando beim automatischen Beenden von efa ausführen")));
      addParameter(efaDirekt_execOnEfaExit = new ItemTypeString("EfaExitExecOnExit", "",
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_STARTSTOP),
          International
              .getString("Folgendes Kommando beim Beenden von efa durch Mitglieder ausführen")));

      // ============================= BOATHOUSE:PERMISSIONS =============================
      addParameter(membersMayReserveBoats = new ItemTypeBoolean("AllowMembersBoatReservation",
          true,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_PERMISSIONS),
          International.getString("Mitglieder dürfen Boote reservieren")));
      addParameter(membersMayReserveBoatsWeekly = new ItemTypeBoolean(
          "AllowMembersBoatReservationWeekly", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_PERMISSIONS),
          International.getString("Mitglieder dürfen Boote reservieren")
              + " (" + International.getString("wöchentliche Reservierungen") + ")"));
      addParameter(membersMayEditBoatsReservations = new ItemTypeBoolean(
          "AllowMembersBoatReservationEdit", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_PERMISSIONS),
          International.getString("Mitglieder dürfen Bootsreservierungen verändern und löschen")));
      addParameter(membersMayReservePrivateBoats = new ItemTypeBoolean(
          "AllowMembersPrivateBoatReservation", true,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_PERMISSIONS),
          International.getString("Mitglieder dürfen Privatboote reservieren")));
      addParameter(efaDirekt_mitgliederDuerfenNamenHinzufuegen = new ItemTypeBoolean(
          "AllowMembersAddNames", false,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_PERMISSIONS),
      ...
      addParameter(efaDirekt_bnrError_admin = new ItemTypeBoolean("NotificationErrorAdmin", true,
          ...
          International.getMessage("Benachrichtigungen verschicken an {to} {on_event}",
              International.getString("Admins"), International.getString("bei Fehlern")
                  + " (ERROR)")));
      addParameter(efaDirekt_bnrWarning_admin = new ItemTypeBoolean("NotificationWarningAdmin",
          true,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_NOTIFICATIONS),
          International.getMessage("Benachrichtigungen verschicken an {to} {on_event}",
      ...
      addParameter(efaDirekt_bnrBootsstatus_admin = new ItemTypeBoolean(
          "NotificationBoatstatusAdmin", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_NOTIFICATIONS),
          International.getMessage("Benachrichtigungen verschicken an {to} {on_event}",
              International.getString("Admins"),
              International.getString("bei Bootsstatus-Änderungen"))));
      addParameter(efaDirekt_bnrError_bootswart = new ItemTypeBoolean(
          "NotificationErrorBoatMaintenance", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_NOTIFICATIONS),
          International.getMessage("Benachrichtigungen verschicken an {to} {on_event}",
              International.getString("Bootswarte"), International.getString("bei Fehlern")
                  + " (ERROR)")));
      addParameter(efaDirekt_bnrWarning_bootswart = new ItemTypeBoolean(
          "NotificationWarningBoatMaintenance", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_NOTIFICATIONS),
          International.getMessage("Benachrichtigungen verschicken an {to} {on_event}",
      ...
      addParameter(efaDirekt_bnrBootsstatus_bootswart = new ItemTypeBoolean(
          "NotificationBoatstatusBoatMaintenance", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_NOTIFICATIONS),
          International.getMessage("Benachrichtigungen verschicken an {to} {on_event}",
              International.getString("Bootswarte"),
      ...
      addParameter(notificationMarkReadBoatMaintenance = new ItemTypeBoolean(
          "NotificationMarkReadBoatMaintenance", false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_NOTIFICATIONS),
          International.getMessage("Nachrichten an {recipient} automatisch als gelesen markieren",
              International.getString("Bootswart"))));
      ...
      addParameter(efaDirekt_emailPort = new ItemTypeInteger("NotificationEmailPort", 25, 0, 65535,
          false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_NOTIFICATIONS),
          International.getString("email") + ": "
      ...
      addParameter(efaDirekt_emailBetreffPraefix = new ItemTypeString(
          "NotificationEmailSubjectPrefix", Daten.EFA_SHORTNAME,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_NOTIFICATIONS),
          International.getString("email") + ": "
      ...
      addParameter(kanuEfb_urlLogin = new ItemTypeString("KanuEfbUrlLogin",
          "https://efb.kanu-efb.de/services/login",
      ...
      addParameter(kanuEfb_urlRequest = new ItemTypeString("KanuEfbUrlRequest",
          "https://efb.kanu-efb.de/services",
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_SYNC, CATEGORY_KANUEFB),
          "Request URL"));
      ...
      addParameter(defaultDistanceUnit = new ItemTypeStringList("LocaleDefaultDistanceUnit",
          ...
          DataTypeDistance.makeDistanceUnitValueArray(),
          DataTypeDistance.makeDistanceUnitNamesArray(),
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_LOCALE),
      ...
      addParameter(useFunctionalityCanoeingGermany = new ItemTypeBoolean(
          "CustUsageCanoeingGermany",
      ...
      addParameter(typesResetToDefault = new ItemTypeAction("ACTION_TYPES_RESETTODEFAULT",
          ItemTypeAction.ACTION_TYPES_RESETTODEFAULT,
      ...
      addParameter(typesAddAllDefault = new ItemTypeAction("ACTION_TYPES_ADDALLDEFAULT",
          ItemTypeAction.ACTION_TYPES_ADDALLDEFAULT,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_TYPES, CATEGORY_COMMON),
      ...
      addParameter(typesAddAllDefaultRowingBoats = new ItemTypeAction("ACTION_ADDTYPES_ROWING",
          ItemTypeAction.ACTION_GENERATE_ROWING_BOAT_TYPES,
          IItemType.TYPE_PUBLIC,
          BaseTabbedDialog.makeCategory(CATEGORY_TYPES, CATEGORY_TYPES_BOAT),
          International.getMessage(
              "Fehlende Standard-Bootstypen für {rowing_or_canoeing} neu generieren",
              International.getString("Rudern"))));
      addParameter(typesAddAllDefaultCanoeingBoats = new ItemTypeAction("ACTION_ADDTYPES_CANOEING",
          ItemTypeAction.ACTION_GENERATE_CANOEING_BOAT_TYPES,
          IItemType.TYPE_PUBLIC,
          BaseTabbedDialog.makeCategory(CATEGORY_TYPES, CATEGORY_TYPES_BOAT),
          International.getMessage(
              "Fehlende Standard-Bootstypen für {rowing_or_canoeing} neu generieren",
      ...
      addParameter(efaDirekt_showUhr = new ItemTypeBoolean("WidgetClockEnabled", true,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_WIDGETS, CATEGORY_WIDGET_CLOCK),
      ...
      addParameter(efaDirekt_showNews = new ItemTypeBoolean("WidgetNewsEnabled", true,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_BOATHOUSE,
              CATEGORY_WIDGETS, CATEGORY_WIDGET_NEWS),
          International.getMessage("{item} anzeigen",
      ...
      addParameter(efaDirekt_newsScrollSpeed = new ItemTypeInteger("WidgetNewsScrollSpeed", 250,
      ...
      // ============================= DATA ACCESS =============================
      addParameter(dataPreModifyRecordCallbackEnabled = new ItemTypeBoolean(
          "DataPreModifyRecordCallbackEnabled", true,
          IItemType.TYPE_EXPERT,
          BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS, CATEGORY_COMMON),
      ...
      addParameter(dataFileSaveInterval = new ItemTypeLong("DataFileSaveInterval", 10, 1, 3600,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAXML),
          "File Save Interval (sec)"));
      addParameter(dataFileSynchronousJournal = new ItemTypeBoolean("DataFileSynchronousJournal",
          true,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAXML),
      ...
      addParameter(dataBackupDirectory = new ItemTypeFile("DataBackupDirectory", "",
          ...
          International.getString("Verzeichnisse"),
          null, ItemTypeFile.MODE_OPEN, ItemTypeFile.TYPE_DIR,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAXML),
          International.getString("Backup-Verzeichnis")));
      ...
      addParameter(dataRemoteEfaServerEnabled = new ItemTypeBoolean("DataRemoteEfaServerEnabled",
          false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAREMOTE),
          International.getString("Remote-Zugriff erlauben")));
      addParameter(dataRemoteEfaServerPort = new ItemTypeInteger("DataRemoteEfaServerPort", 0xEFA,
          1, 65535,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAREMOTE),
          International.getString("Server Port")));
      addParameter(dataRemoteCacheExpiryTime = new ItemTypeLong("DataRemoteCacheExpiryTime", 10, 1,
          3600,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAREMOTE),
          "Cache Expiry Time (sec)"));
      addParameter(dataRemoteIsOpenExpiryTime = new ItemTypeLong("DataRemoteIsOpenExpiryTime", 60,
          1, 3600,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAREMOTE),
          "IsStorageObjectOpen Expiry Time (sec)"));
      addParameter(dataRemoteLoginFailureRetryTime = new ItemTypeLong(
          "DataRemoteLoginFailureRetryDelay", 600, 60, 24 * 3600,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAREMOTE),
          "Login Failure Retry Delay (sec)"));
      addParameter(dataRemoteClientReceiveTimeout = new ItemTypeLong(
          "DataRemoteClientReceiveTimeout", 60, 10, 600,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAREMOTE),
          "Client Receive Timeout (sec)"));

      addParameter(dataRemoteEfaOnlineEnabled = new ItemTypeBoolean("DataRemoteEfaOnlineEnabled",
          false,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAREMOTE),
      ...
      addParameter(dataRemoteEfaOnlinePassword = new ItemTypePassword(
          "DataRemoteEfaOnlinePassword", "", true,
          IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAREMOTE),
          Daten.EFA_ONLINE + " - " +
              International.getString("Paßwort") +
      ...
      addParameter(dataRemoteEfaOnlineUrl = new ItemTypeString("DataRemoteEfaOnlineUrl",
          "http://efa-online.nmichael.de/efa",
          IItemType.TYPE_INTERNAL, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAREMOTE),
          "efaOnline URL"));
      addParameter(dataRemoteEfaOnlineUpdateInterval = new ItemTypeLong(
          "DataRemoteEfaOnlineUpdateInverval", 3600, 60, 24 * 3600,
          IItemType.TYPE_EXPERT, BaseTabbedDialog.makeCategory(CATEGORY_DATAACCESS,
              CATEGORY_DATAREMOTE),
  ...
  private void addParameter(IItemType configValue) {
    synchronized (configValues) {
      if (configValues.get(configValue.getName()) != null) {
        ...
        Logger.log(Logger.ERROR, Logger.MSG_ERROR_EXCEPTION, "EfaConfig: duplicate parameter: "
            + configValue.getName());
      } else {
  ...
  public void setExternalParameters(boolean isGuiConfigChange) {
    // first, set all external parameters that have to be set in any case, e.g. also if EfaConfig
    // has been read after startup

    // set Debug Logging and Trace Topic (will only take effect if it has not been set through
    // command line previously!!)
    ...
    // if isGuiConfigChange, i.e. if interactive changes have been made by the user, set other
    // parameters as well
    ...
    boolean changedLang = Daten.efaBaseConfig.language == null
        || !Daten.efaBaseConfig.language.equals(newLang);
    ...
    if (changedLang || changedUserDir) {
      ...
      if (changedUserDir) {
        Dialog.infoDialog(International.getString("Verzeichnis für Nutzerdaten"),
            LogString.onlyEffectiveAfterRestart(International
                .getString("Verzeichnis für Nutzerdaten")));
      }
    }
          ...
          synchronized (configValues) {
            while (k != null) {
              ...
              if (r.getName().startsWith("_")) {
                continue; // it shouldn't happen that such a value actually made it into the file,
                // but you never know...
              }
