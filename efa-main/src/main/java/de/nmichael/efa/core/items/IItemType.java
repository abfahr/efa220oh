...
public interface IItemType {
  ...
  /**
   * Perform a copy of this Item. This is not really a deep copy. For most items, this copy method
   * will only copy those values which are passed to the object in the constructor. Other properties
   * may not be copied. The only purpose of this method is to copy GUI items used in EfaConfig, to
