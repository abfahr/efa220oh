...
public class ItemTypeMultiSelectList<T> extends ItemType implements ActionListener {
  ...
  public ItemTypeMultiSelectList(String name, DataTypeList<T> value, T[] keyData,
      String[] displayData,
  ...
  public ItemTypeMultiSelectList copyOf() {
    ItemTypeMultiSelectList mylist = new ItemTypeMultiSelectList(name, new DataTypeList<T>(value),
