...
public class BoatStatusRecord extends DataRecord {
  ...
  public static final String STATUS_NOTAVAILABLE = "NOTAVAILABLE"; // BaseStatus StatusList
  // CurrentStatus
  ...
  public static final String BOATID = "BoatId"; // most point to an exisiting boat, unless
  // UNKNOWNBOAT=true
  public static final String BOATTEXT = "BoatText"; // Boat Name copied from BoatRecord or set
  // explicitly for unknown boats
  public static final String UNKNOWNBOAT = "UnknownBoat"; // must be set to "true" if this boat does
  // not appear in the boat list
  public static final String BASESTATUS = "BaseStatus"; // the base status that this boat falls back
  // to if it's not on the water
  public static final String CURRENTSTATUS = "CurrentStatus"; // current status - may be on the
  // water
  ...
  public Vector<IItemType> getGuiItems(AdminRecord admin) {
    ...
    v.add(item = new ItemTypeLabel("GUI_BOAT_NAME",
        IItemType.TYPE_PUBLIC, CAT_STATUS, International.getMessage("Bootsstatus für {boat}",
            getBoatNameAsString(System.currentTimeMillis()))));
