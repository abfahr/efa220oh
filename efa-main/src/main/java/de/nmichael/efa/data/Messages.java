...
public class Messages extends StorageObject {
  ...
  public Messages(int storageType,
    ...
    super(storageType, storageLocation, storageUsername, storagePassword, storageObjectName,
        DATATYPE, International.getString("Nachrichten"));
  ...
  public long countUnreadMessages() {
    ...
    try {
      ...
      // we cannot explicitly count records with READ set to false, as "false" is a value not stored
      // in the record.
      // therefore, we have to count the true's, and substract them from the total count.
      long msgRead = data().countRecords(new String[] { MessageRecord.READ },
