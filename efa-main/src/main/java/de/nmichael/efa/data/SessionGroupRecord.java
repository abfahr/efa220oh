...
public class SessionGroupRecord extends DataRecord {
  ...
  public Vector<LogbookRecord> getAllReferencingLogbookRecords() {
    ...
    Logbook logbook = (logbookName != null ? getPersistence().getProject().getLogbook(logbookName,
        false) : null);
    UUID id = getId();
  ...
  public boolean checkLogbookRecordFitsIntoRange(LogbookRecord r) {
    if (getStartDate() != null && getEndDate() != null && getStartDate().isSet()
        && getEndDate().isSet()) {
      if (r.getDate() != null && r.getDate().isSet()
          && (r.getDate().isBefore(getStartDate()) || r.getDate().isAfter(getEndDate()))) {
        return false;
      }
      if (r.getEndDate() != null && r.getEndDate().isSet()
          && (r.getEndDate().isBefore(getStartDate()) || r.getEndDate().isAfter(getEndDate()))) {
        return false;
      }
    }
    return true;
  ...
  public Vector<IItemType> getGuiItems(AdminRecord admin) {
    ...
    item.setNotNull(true);
    ((ItemTypeDate) item).setMustBeAfter(startDate, true);
