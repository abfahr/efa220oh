...
public class RemoteEfaMessage {
  ...
  public RemoteEfaMessage(int msgId, Type type, String operation, String storageObjectType,
  ...
  public String[] getFieldArrayValues() {
    int count = 0;
    while (getFieldValue(FIELD_FIELDNAME + count) != null) { // for the number of fields, we check
      // for FIELD_FIELDNAME, not for
      // FIELD_FIELDVALUE!!
      count++;
    }
    String[] a = new String[count];
  ...
  public String toString() {
    ...
    if (fields != null) {
      ...
      for (String fieldName : fieldNames) {
        s.append("<" + fieldName + ">" +
            EfaUtil.escapeXml(fields.get(fieldName)) + "</" +
            fieldName + ">");
      }
    }
  ...
  public static RemoteEfaMessage createRequestData(int msgId, String storageObjectType,
      String storageObjectName, String operation) {
    RemoteEfaMessage r = new RemoteEfaMessage(msgId, Type.request, operation, storageObjectType,
        storageObjectName);
    return r;
  }
