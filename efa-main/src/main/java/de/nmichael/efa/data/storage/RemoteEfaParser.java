...
public class RemoteEfaParser extends XmlHandler {
    ...
    if (dataAccess == null && message != null) {
      ...
      if (storageObjectName != null && storageObjectName.length() > 0 &&
        ...
        if (Daten.project != null) {
          ...
          boolean createNewIfDoesntExist = RemoteEfaMessage.OPERATION_CREATESTORAGEOBJECT
              .equals(message.getOperationName());
          p = Daten.project.getStorageObject(storageObjectName, storageObjectType,
  ...
  public void endElement(String uri, String localName, String qname) {
    ...
    if (inRequestResponse && !inRecord && !inKey
        && localName.equals(RemoteEfaMessage.TYPE_RESPONSE)) {
      // end of response
      inRequestResponse = false;
      iniDataAccess();
      message.setDataAccess(dataAccess);
