...
public class DataTypeDate implements Cloneable, Comparable<DataTypeDate> {
  ...
  public GregorianCalendar toCalendar() {
    ...
    int _month = (month > 0 ? month : 1); // if month is not specified (month==0), assume first of
    // year
  ...
  public static boolean isRangeOverlap(DataTypeDate r1From, DataTypeDate r1To, DataTypeDate r2From,
      DataTypeDate r2To) {
  ...
  public static DataTypeDate[] getRangeOverlap(DataTypeDate r1From, DataTypeDate r1To,
      DataTypeDate r2From, DataTypeDate r2To) throws Exception {
  ...
  public static int getMonthIntersect(DataTypeDate from, DataTypeDate to, DataTypeDate from2,
      DataTypeDate to2) {
   ...
   *
   * @param format the format, which *must* contain DD, MM and YYYY, e.g. "DD.MM.YYYY" or
   *          "YYYY-MM-DD"
   * @return
   */
