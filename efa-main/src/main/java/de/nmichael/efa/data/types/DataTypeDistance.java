...
public class DataTypeDistance {
  ...
  /**
   * 1 km = 1000m 1 yd = 0.9144 m 1 mi = 1.609344 km 1 mi = 1760 yd
   */
  ...
  public long getValueInMeters() {
    ...
    switch (unit) {
      ...
      case mi:
        return Math.round((value.getValue(3)) * 1.609344);
      case yd:
        return Math.round((value.getValue(0)) * 0.9144);
    }
    return 0;
  }
  ...
  public long getValueInYards() {
    ...
    switch (unit) {
      case km:
        return Math.round((value.getValue(3)) / 0.9144);
      case m:
        return Math.round((value.getValue(0)) / 0.9144);
      case mi:
        return (value.getValue(3) * 1760) / 1000;
      case yd:
        return value.getValue(0);
    }
    return 0;
  ...
  public String getStringValueInKilometers(boolean withUnit, int minDecimalPlaces,
      int maxDecimalPlaces) {
    return getStringValueInKilometers(withUnit, true, minDecimalPlaces, maxDecimalPlaces);
  }

  private String getStringValueInKilometers(boolean withUnit, boolean formatted,
      int minDecimalPlaces, int maxDecimalPlaces) {
  ...
  private String getStringValueInMiles(boolean withUnit, boolean formatted, int minDecimalPlaces,
      int maxDecimalPlaces) {
  ...
  public String getStringValueInDefaultUnit(boolean withUnit, int minDecimalPlaces,
      int maxDecimalPlaces) {
    return getStringValueInDefaultUnit(withUnit, true, minDecimalPlaces, maxDecimalPlaces);
  }

  private String getStringValueInDefaultUnit(boolean withUnit, boolean formatted,
      int minDecimalPlaces, int maxDecimalPlaces) {
    if (getDefaultUnit() == UnitType.km) {
