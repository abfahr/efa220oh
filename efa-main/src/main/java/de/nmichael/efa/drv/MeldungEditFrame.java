...
public class MeldungEditFrame extends JDialog implements ActionListener {
  ...
  private void jbInit() throws Exception {
    ...
    try {
      ...
      northPanel.add(labelVerein, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      northPanel.add(labelQnr, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      ...
      switch (MELDTYP) {
        case MeldungenIndexFrame.MELD_WANDERRUDERSTATISTIK:
          southPanel.add(nachfrageButton, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
              GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
          break;
      }
      vereinPanel.add(labelMitglNr, new GridBagConstraints(4, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      vereinPanel.add(vMitgliedsnr, new GridBagConstraints(5, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      vereinPanel.add(labelVereinsname, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      ...
      vereinPanel.add(vNutzername, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      vereinPanel.add(labelBenutzername, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      vereinsdatenPanel.add(meldenderPanel,
          new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
              GridBagConstraints.HORIZONTAL, new Insets(10, 10, 0, 10), 0, 0));
      meldenderPanel.add(labelName, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      ...
      meldenderPanel.add(vMeldenderName, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
      meldenderPanel.add(labelEmail, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      meldenderPanel.add(vMeldenderEmail, new GridBagConstraints(4, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
      vereinsdatenPanel.add(versandPanel,
          new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
              GridBagConstraints.HORIZONTAL, new Insets(10, 10, 0, 10), 0, 0));
      versandPanel.add(vLabelOrt, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      versandPanel.add(vLabelStrasse, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      versandPanel.add(vLabelName, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      ...
      versandPanel.add(vVersandOrt, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      vereinsdatenPanel.add(bestellungenPanel,
          new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
              GridBagConstraints.HORIZONTAL, new Insets(10, 10, 0, 10), 0, 0));
      bestellungenPanel.add(vLabelErwGold, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      bestellungenPanel.add(vLabelAnstecknadeln, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      bestellungenPanel.add(vLabelErwSilber, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      bestellungenPanel.add(vBestNadelErwSilber, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      bestellungenPanel.add(vLabelErwGold2, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      bestellungenPanel.add(vBestNadelErwGold, new GridBagConstraints(4, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      bestellungenPanel.add(vLabelJugSilber, new GridBagConstraints(5, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      ...
      bestellungenPanel.add(vBestStoffErw, new GridBagConstraints(4, 1, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      bestellungenPanel.add(vLabelJug, new GridBagConstraints(5, 1, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      ...
      bestellungenPanel.add(printStoffBestellButton, new GridBagConstraints(5, 2, 4, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
      vereinsdatenPanel.add(vUnblockButton, new GridBagConstraints(0, 7, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(20, 0, 10, 0), 0, 0));
      vereinsdatenPanel.add(zusammenfassungPanel,
      ...
      zusammenfassungPanel.add(vZusGemTeilnehmer, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      zusammenfassungPanel.add(vZusammenfassungAnzTeilnehmer, new GridBagConstraints(1, 1, 1, 1,
          0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0,
          0));
      zusammenfassungPanel.add(vZusTeilnehmerErfuellt, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      zusammenfassungPanel.add(vZusammenfassungAnzTeilnehmerErfuellt, new GridBagConstraints(1, 2,
          1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
          new Insets(0, 0, 0, 0), 0, 0));
      zusammenfassungPanel.add(vZusTeilnehmerUngueltig, new GridBagConstraints(0, 3, 1, 1, 0.0,
          0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      zusammenfassungPanel.add(vZusammenfassungAnzTeilnehmerUngueltig, new GridBagConstraints(1, 3,
          1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
          new Insets(0, 0, 0, 0), 0, 0));
      ...
      zusammenfassungPanel.add(vZusammenfassungMeldegebuehr, new GridBagConstraints(3, 2, 1, 1,
          0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0,
          0));
      zusammenfassungPanel.add(vBetragStoffLabel, new GridBagConstraints(2, 3, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
      zusammenfassungPanel.add(vZusammenfassungStoffabzeichen, new GridBagConstraints(3, 3, 1, 1,
          0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0,
          0));
      zusammenfassungPanel.add(papierFahrtenhefteErforderlichLabel, new GridBagConstraints(0, 5, 2,
          1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 0, 0, 0),
          5, 0));
      zusammenfassungPanel.add(vBetragGesamtLabel, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
      zusammenfassungPanel.add(vZusammenfassungEurGesamt, new GridBagConstraints(3, 1, 1, 1, 0.0,
      ...
      zusammenfassungPanel.add(vAnzahlPapierFahrtenhefte, new GridBagConstraints(3, 5, 1, 1, 0.0,
          0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(8, 0, 0, 0), 0,
          0));
      ...
      zusammenfassungPanel.add(vAktiveWab19, new GridBagConstraints(8, 4, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      vereinsdatenPanel.add(notesPanel,
          new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
              GridBagConstraints.HORIZONTAL, new Insets(10, 10, 0, 10), 0, 0));
      vereinsdatenPanel.add(dateiPanel,
      ...
      switch (MELDTYP) {
        case MeldungenIndexFrame.MELD_FAHRTENABZEICHEN:
          teilnehmerPanel.add(teilnDataPanel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
              GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(20, 0, 0, 0), 0,
              0));
      ...
      fahrtenDataPanel.add(jLabelLfdNr, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fLfdNr, new GridBagConstraints(1, 0, 6, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel8, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fStartZiel, new GridBagConstraints(1, 1, 6, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabelStrecke, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fStrecke, new GridBagConstraints(1, 2, 6, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel10, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fGewaesser, new GridBagConstraints(1, 3, 6, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(addGewaesser, new GridBagConstraints(7, 3, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel11, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fKilometer, new GridBagConstraints(5, 4, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fTage, new GridBagConstraints(2, 4, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel55, new GridBagConstraints(1, 4, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));

      fahrtenDataPanel.add(jLabel58, new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel59, new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel60, new GridBagConstraints(0, 7, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel61, new GridBagConstraints(0, 8, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel62, new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel63, new GridBagConstraints(1, 6, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel64, new GridBagConstraints(1, 7, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel65, new GridBagConstraints(1, 8, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));

      fahrtenDataPanel.add(jLabel56, new GridBagConstraints(1, 9, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      fahrtenDataPanel.add(fTeilnehmer, new GridBagConstraints(2, 9, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fMannschKm, new GridBagConstraints(4, 9, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fMaennerAnz, new GridBagConstraints(2, 5, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fJuniorenAnz, new GridBagConstraints(2, 6, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fFrauenAnz, new GridBagConstraints(2, 7, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fJuniorinnenAnz, new GridBagConstraints(2, 8, 1, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fMaennerKm, new GridBagConstraints(4, 5, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fJuniorenKm, new GridBagConstraints(4, 6, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fFrauenKm, new GridBagConstraints(4, 7, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fJuniorinnenKm, new GridBagConstraints(4, 8, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel66, new GridBagConstraints(3, 5, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel67, new GridBagConstraints(3, 6, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel68, new GridBagConstraints(3, 7, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel69, new GridBagConstraints(3, 8, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel57, new GridBagConstraints(3, 9, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      fahrtenDataPanel.add(jLabel70, new GridBagConstraints(3, 4, 2, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
      fahrtenDataPanel.add(fUnblockButton, new GridBagConstraints(0, 10, 7, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(10, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fWirdGewertet, new GridBagConstraints(0, 11, 2, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fNichtGewertetGrundLabel, new GridBagConstraints(3, 11, 2, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fNichtGewertetGrund, new GridBagConstraints(5, 11, 2, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

      fahrtenDataPanel.add(fNachfrageCheckBox, new GridBagConstraints(0, 12, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenDataPanel.add(fNachfrage, new GridBagConstraints(1, 12, 6, 1, 0.0, 0.0,
          GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

      fahrtenDataPanel.add(jLabel22, new GridBagConstraints(0, 9, 1, 1, 0.0, 0.0,
          GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
  ...
  void iniFields() {
    switch (MELDTYP) {
      case MeldungenIndexFrame.MELD_FAHRTENABZEICHEN:
        ...
        teilnDataPanel.add(mFahrtnachweisErbracht, new GridBagConstraints(7, 2 + MAX_FAHRTEN, 6, 1,
  ...
  void printDiff(String field, String olds, String news) {
    ...
    if ((olds == null || news == null)
        || !olds.equals(news)) {
      log(true, "Wert für Feld '" + field + "' geändert: alt='" + (olds == null ? "" : olds)
          + "', neu='" + (news == null ? "" : news) + "'");
    }
  }
          ...
          if (ewm.drvSignatur.getSignatureState() == DRVSignatur.SIG_VALID) {
            ...
            if (ewm.drvSignatur.getJahr() >= Main.drvConfig.aktJahr) {
              ewm.sigError = (ewm.sigError == null ? "" : ewm.sigError + "\n")
                  + "Fahrtenheft des Teilnehmers wurde für eine Meldung des Jahres "
                  + ewm.drvSignatur.getJahr()
                  + " ausgestellt und kann daher im aktuellen Meldejahr " + Main.drvConfig.aktJahr
      ...
      switch (MELDTYP) {
        case MeldungenIndexFrame.MELD_FAHRTENABZEICHEN:
          if (!ewm.drvint_wirdGewertetExplizitGesetzt || ewm.drvint_wirdGewertet) {
            // Die Eigenschaft "wirdGewertet" kann auch vom DRV durch eine frühere Bearbeitung
            // bereits in die Datei
            // geschrieben worden sein. In diesem Fall hat "wirdGewertetExplizitGesetzt" den Wert
            // "true".
            // Beim Einlesen der Meldedatei wird die Eigenschaft "wirdGewertet" nur dann von efa neu
            // bestimmt, wenn
            // sie nicht zuvor explizit gesetzt war, oder wenn sie "true" ist (in diesem Fall bleibt
            // das "true" nur
            // erhalten, wenn die Meldung wirklich gültig ist).
            ewm.drvint_wirdGewertet = ((ewm.sigValid || ewm.drvSignatur == null) && isErfuellt(ewm,
                false));
          }
          break;
        case MeldungenIndexFrame.MELD_WANDERRUDERSTATISTIK:
          ...
          ewm.drvint_geprueft = (checkAndCorrectWSAnz(ewm, false) == null)
              && (checkAndCorrectWSKm(ewm, false) == null) && ewm.drvint_wirdGewertet;
          break;
      }
      data.add(ewm);
    }
  ...
  void setFahrtenheftState(EfaWettMeldung ewm) {
    if (ewm.drvSignatur == null) {
      ...
      if (ewm.sigValid) {
        mFahrtenheft.setText("Das elektronische Fahrtenheft ist gültig! (Letzte Meldung: "
            + ewm.drvSignatur.getJahr() + ")");
        mFahrtenheft.setForeground(Daten.colorGreen);
      } else {
  ...
  String checkAndCorrectAbzeichen(EfaWettMeldung ewm) {
    ...
    String abzeichen = WettDefs.getDRVAbzeichen(erwachsen, anzAbzeichen, anzAbzeichenAB,
  ...
  String checkAndCorrectAequator(EfaWettMeldung ewm) {
    ...
    if (aeq != null || ewm.drv_aequatorpreis != null) {
      if (aeq == null) {
        ...
        ewm.changed = true;
        return "Teilnehmer hat für Äquatorpreis '" + gem
            + "' gemeldet, hat ihn aber nicht erfüllt. Äquatorpreis wurde korrigiert!";
      } else if (ewm.drv_aequatorpreis == null) {
        ewm.drv_aequatorpreis = aeq;
        ewm.changed = true;
        return "Teilnehmer hat für Äquatorpreis nicht gemeldet, hat ihn aber zum " + aeq
            + ". Mal erfüllt. Äquatorpreis wurde korrigiert!";
      } else if (!aeq.equals(ewm.drv_aequatorpreis)) {
        String gem = ewm.drv_aequatorpreis;
        ewm.drv_aequatorpreis = aeq;
        ewm.changed = true;
        return "Teilnehmer hat für Äquatorpreis '" + gem + "' gemeldet, hat ihn aber zum " + aeq
            + ". Mal erfüllt. Äquatorpreis wurde korrigiert!";
      }
    }
    return null;
    ...
    switch (MELDTYP) {
      case MeldungenIndexFrame.MELD_FAHRTENABZEICHEN:
        ...
        if (ew.drv_nadel_erw_gold != null) {
          this.vBestNadelErwGold.setText(Integer.toString(EfaUtil.sumUpArray(EfaUtil
              .kommaList2IntArr(ew.drv_nadel_erw_gold, ','))));
        }
        this.vBestNadelJugSilber.setText(notNull(ew.drv_nadel_jug_silber));
        if (ew.drv_nadel_jug_gold != null) {
          this.vBestNadelJugGold.setText(Integer.toString(EfaUtil.sumUpArray(EfaUtil
              .kommaList2IntArr(ew.drv_nadel_jug_gold, ','))));
        }
        ...
        if (ew.drvint_anzahlPapierFahrtenhefte >= 0) {
          this.vAnzahlPapierFahrtenhefte.setText(Integer
              .toString(ew.drvint_anzahlPapierFahrtenhefte));
        }
        break;
      case MeldungenIndexFrame.MELD_WANDERRUDERSTATISTIK:
  ...
  void setMFields(int nr, boolean bestimmeWirdGewertetNeu) {
    ...
    switch (MELDTYP) {
      case MeldungenIndexFrame.MELD_FAHRTENABZEICHEN:
        ...
        mAequatorpreis.setForeground((!aeq.startsWith("(") && !aeq.equals("nein") ? Color.blue
            : Color.black));
        ...
        this.mNichtGewertetGrund.setText((ewmCur.drvint_nichtGewertetGrund == null ? ""
            : ewmCur.drvint_nichtGewertetGrund));
        ...
        if (ewmCur.fahrt != null) {
          ...
          if (anzFahrten >= MAX_FAHRTEN) {
            warnung("Für den Teilnehmer sind mehr als " + MAX_FAHRTEN
                + " Fahrten angegeben; die restlichen Fahrten werden ignoriert.");
          }
        }
      ...
      case MeldungenIndexFrame.MELD_WANDERRUDERSTATISTIK:
        ...
        updateStatusNichtGewertetGrund();
        this.fNichtGewertetGrund.setText((ewmCur.drvint_nichtGewertetGrund == null ? ""
            : ewmCur.drvint_nichtGewertetGrund));
        this.fNachfrageCheckBox.setSelected(ewmCur.drvint_nachfrage != null
            && ewmCur.drvint_nachfrage.length() > 0);
          ...
          if (d != null) {
            if (!d.get(Teilnehmer.VORNAME).equals(mVorname.getText().trim())
              ...
              if (Dialog
                  .yesNoDialog(
                      "Warnung",
                      "Es existiert bereits ein Teilnehmer mit der Nummer "
                          + d.get(Teilnehmer.TEILNNR)
                          + ",\n"
                          + "jedoch hat dieser Teilnehmer andere Daten:\n"
                          + "'"
                          + d.get(Teilnehmer.VORNAME)
                          + " "
                          + d.get(Teilnehmer.NACHNAME)
                          + " ("
                          + d.get(Teilnehmer.JAHRGANG)
                          + ")'\n"
    ...
    switch (MELDTYP) {
      case MeldungenIndexFrame.MELD_FAHRTENABZEICHEN:
        ...
        meldegeld += EfaUtil.string2int(ew.drv_nadel_jug_silber, 0)
            * Main.drvConfig.eur_nadel_jug_silber;
        meldegeld += EfaUtil.sumUpArray(EfaUtil.kommaList2IntArr(ew.drv_nadel_jug_gold, ','))
            * Main.drvConfig.eur_nadel_jug_gold;
      ...
      case MeldungenIndexFrame.MELD_FAHRTENABZEICHEN:
        ...
        if (gruppe != null && ewm.gruppe != null) {
          if (!ewm.gruppe.startsWith(gruppe) && testeUndKorrigiere) {
            warnung("Teilnehmer hat für Gruppe '" + ewm.gruppe
                + "' gemeldet, hat aber für Gruppe '" + gruppe
                + "' erfüllt. Gruppe wurde korrigiert!");
            ewm.gruppe = gruppe;
            ewm.changed = true;
          }
        }
  ...
  String getGruppe(EfaWettMeldung ewm) {
    ...
    if (ewm.fahrt != null) {
      for (int i = 0; i < ewm.fahrt.length && i < MAX_FAHRTEN; i++) {
        ...
        if (ewm.fahrt[i][1] != null && ewm.fahrt[i][2] != null && !jum) {
          ...
          if (von.tag != 0 && von.monat != 0 && von.jahr != 0 && bis.tag != 0 && bis.monat != 0
              && bis.jahr != 0) {
    ...
    if (ewm.drvint_fahrtErfuellt) { // nicht Zusatzbedingungen prüfen, sondern als erfüllt
      // betrachten
      wafaKm = 99999;
      wafaAnzTage = 99999;
      jumAnz = 99999;
  ...
  void bestaetigenButton_actionPerformed(ActionEvent e) {
    ...
    for (int i = 0; i < data.size(); i++) {
      ...
      if (!ewm.drvint_geprueft && !Main.drvConfig.readOnlyMode) {
        Dialog.error("Meldung " + (i + 1)
            + " wurde noch nicht geprüft! Es müssen zuerst alle Meldungen geprüft werden!");
        setMFields(i, false);
    ...
    if (c < data.size()) {
      if (Dialog.yesNoDialog("Warnung", "Es sind nur " + c + " von " + data.size()
          + " Teilnehmern als 'wird gewertet' markiert.\nIst das korrekt?") != Dialog.YES) {
        return;
      }
    }
    ...
    if (MELDTYP == MeldungenIndexFrame.MELD_FAHRTENABZEICHEN) {
      if ((new File(ew.datei + "sig")).exists()) {
        if (Dialog
            .yesNoDialog(
                "Warnung",
                "Eine Bestätigungsdatei für diese Meldung existiert bereits.\nSoll trotzdem eine neue erstellt werden?") != Dialog.YES) {
          return;
        }
      }
    }
    ...
    if (MELDTYP == MeldungenIndexFrame.MELD_FAHRTENABZEICHEN) {
      ...
      for (int i = 0; i < data.size(); i++) {
        ...
        if (gruppe == null) {
          errors += "Teilnehmer " + (i + 1) + " (" + m.vorname + " " + m.nachname
              + ") wurde nicht gewertet, da er/sie die Bedingungen nicht erfüllt hat.\n";
          nichtGewerteteTeilnehmer.add(m.vorname + " " + m.nachname
              + " (Grund: Wettbewerbsbedingungen nicht erfüllt)");
          continue;
        }

        // prüfen, ob Gruppe der Meldung entspricht
        if (!gruppe.equals(m.gruppe)) {
          warnings += "Teilnehmer " + (i + 1) + " (" + m.vorname + " " + m.nachname
              + ") wurde für Gruppe '" + m.gruppe + "' gemeldet, hat aber in Gruppe '" + gruppe
              + "' erfüllt. Gruppe wurde korrigiert.\n";
        }
        ...
        if (anzAbz < anzAbzAB || gesKm < gesKmAB) {
          errors += "Teilnehmer "
              ...
              + " "
              + m.nachname
              + ") wurde nicht gewertet, da er/sie ungültige Werte der Abzeichen/Kilometer (mehr AB als normal) hat.\n";
          nichtGewerteteTeilnehmer.add(m.vorname + " " + m.nachname
              + " (Grund: Unstimmige Werte der Abzeichen/Kilometer für Jugend-A/B)");
          continue;
        }
        ...
        if (!Main.drvConfig.readOnlyMode) {
          ...
          if (m.drv_teilnNr == null || m.drv_teilnNr.length() == 0) {
            long l = EfaUtil.getSHAlong(
                (m.vorname + "#" + m.nachname + "#" + m.jahrgang).getBytes(), 3);
            if (l < 0) {
              errors += "Für Teilnehmer " + (i + 1) + " (" + m.vorname + " " + m.nachname
                  + ") konnte keine Teilnehmernummer berechnet werden (-1).\n";
              nichtGewerteteTeilnehmer.add(m.vorname + " " + m.nachname
                  + " (Grund: Es konnte keine Teilnehmernummer berechnet werden)");
              continue;
            }
        ...
        if (!Main.drvConfig.readOnlyMode) {
          try {
            ...
            if (privKey == null) {
              errors += "Privater Schlüssel " + Main.drvConfig.schluessel + " nicht gefunden: "
            ...
            if (sig.getSignatureState() != DRVSignatur.SIG_VALID) {
              errors += "Teilnehmer " + (i + 1) + " (" + m.vorname + " " + m.nachname
                  + ") wurde nicht gewertet, da die für ihr erstellte Signatur ungültig ist: "
                  + sig.getSignatureError() + "\n";
              nichtGewerteteTeilnehmer.add(m.vorname + " " + m.nachname
                  + " (Grund: Erstellte Signatur ist ungültig)");
              continue;
            } else {
            ...
            errors += "Fehler beim Erstellen des elektronischen Fahrtenhefts für Teilnehmer "
                + (i + 1) + " (" + m.vorname + " " + m.nachname + "): " + ee.getMessage() + "\n";
          }
        } else {
          opSuccess = true;
        }
        ...
        if (opSuccess) {
          ...
          d.set(Meldestatistik.KEY, ew.verein_mitglnr + "#" + m.vorname + "#" + m.nachname + "#"
              + m.jahrgang);
          ...
          if (m.drv_aequatorpreis != null
              && (m.drv_aequatorpreis.equals("1") || m.drv_aequatorpreis.equals("3"))) {
    ...
    try {
      if (c <= 0) {
        errors += "Es wurden keine "
            + (MELDTYP == MeldungenIndexFrame.MELD_FAHRTENABZEICHEN ? "Teilnehmer" : "Fahrten")
            + " gewertet!\n";
      } else {
        if (MELDTYP == MeldungenIndexFrame.MELD_FAHRTENABZEICHEN && !Main.drvConfig.readOnlyMode) {
          f.writeFile();
    ...
    if (MELDTYP == MeldungenIndexFrame.MELD_FAHRTENABZEICHEN
        && !Main.drvConfig.teilnehmer.writeFile()) {
    ...
    if (c > 0) {
      if (MELDTYP == MeldungenIndexFrame.MELD_FAHRTENABZEICHEN && !Main.drvConfig.readOnlyMode) {
        Dialog.infoDialog("Es wurden " + c + " von " + data.size()
            + " Teilnehmern gewertet und ein elektronisches Fahrtenbuch\n"
            + "für sie generiert.\n"
            + "Bestätigungsdatei: " + f.getDateiname()
            + "\n\nEs wird nun ein PDF-Dokument mit den elektronischen Fahrtenheften erzeugt.");
        try {
          PDFOutput.printPDFbestaetigung(Main.drvConfig, ew, qnr, meldegeld, data.size(), c,
              teilnErw, teilnJug, f, nichtGewerteteTeilnehmer);
  ...
  void nachfrageButton_actionPerformed(ActionEvent e) {
    ...
    h.append("Zu Ihrer Meldung " + qnr + " (Verein: " + ew.verein_name
        + ") für die DRV-Wanderruderstatistik " +
  ...
  void vBlock(boolean blocked) {
    ...
    if (blocked) {
      ...
      if (EfaUtil.string2int(this.vBestNadelErwGold.getText().trim(), 0) != EfaUtil
          .sumUpArray(EfaUtil.kommaList2IntArr(ew.drv_nadel_erw_gold, ','))) {
        ew.drv_nadel_erw_gold = this.vBestNadelErwGold.getText().trim();
      }
      ew.drv_nadel_erw_silber = this.vBestNadelErwSilber.getText().trim();
      if (EfaUtil.string2int(this.vBestNadelJugGold.getText().trim(), 0) != EfaUtil
          .sumUpArray(EfaUtil.kommaList2IntArr(ew.drv_nadel_jug_gold, ','))) {
      ...
      ew.drvint_anzahlPapierFahrtenhefte = EfaUtil.string2int(this.vAnzahlPapierFahrtenhefte
          .getText().trim(), -1);
      ew.drvint_notes = vNotes.getText().trim();
      ew.aktive_M_bis18 = Integer.toString(EfaUtil.string2int(this.vAktiveMbis18.getText().trim(),
          0));
      ew.aktive_M_ab19 = Integer
          .toString(EfaUtil.string2int(this.vAktiveMab19.getText().trim(), 0));
      ew.aktive_W_bis18 = Integer.toString(EfaUtil.string2int(this.vAktiveWbis18.getText().trim(),
          0));
      ew.aktive_W_ab19 = Integer
          .toString(EfaUtil.string2int(this.vAktiveWab19.getText().trim(), 0));
  ...
  boolean loadKeys() {
    ...
    Daten.keyStore = new EfaKeyStore(Daten.efaDataDirectory + DRVConfig.KEYSTORE_FILE,
        Main.drvConfig.keyPassword);
  ...
  void mTeilnSuchenButton_actionPerformed(ActionEvent e) {
    ...
    Dialog.error("Es wurden mehrere Teilnehmer '" + vorname + " " + nachname + " (" + jahrgang
        + ")' gefunden.\nTeilnehmernummern: " + s);
  }
  ...
  void printStoffBestellButton_actionPerformed(ActionEvent e) {
    ...
    try {
      BufferedWriter f = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(tmpdatei),
          Daten.ENCODING_UTF));
      f.write("<html>\n");
      f.write("<head><META http-equiv=\"Content-Type\" content=\"text/html; charset="
          + Daten.ENCODING_UTF + "\"></head>\n");
      f.write("<body>\n");
      ...
      f.write("<tr><td>DRV-Mitgliedsnummer:</td><td><tt><b>" + ew.verein_mitglnr
          + "</b></tt></td></tr>\n");
      ...
      f.write("<tr><td>Stoffabzeichen Jugend:</td><td><tt><b>" + ew.drv_stoff_jug
          + "</b></tt></td></tr>\n");
      f.write("<tr><td>Stoffabzeichen Erwachsene gold:</td><td><tt><b>" + ew.drv_stoff_erw
          + "</b></tt></td></tr>\n");
      ...
      f.write("<tr><td>Bestellwert:</td><td><tt><b>" + EfaUtil.cent2euro(cent, true)
          + "</b></tt></td></tr>\n");
      f.write("</table>\n");
      f.write("</body></html>\n");
      f.close();
  ...
  void aequatorButton_actionPerformed(ActionEvent e) {
    ...
    for (int i = 0; i < data.size(); i++) {
      ...
      if (ewm.drv_aequatorpreis != null && ewm.drv_aequatorpreis.length() > 0
        ...
        if (isErfuellt(ewm, false) && ewm.drvint_wirdGewertet) {
          ...
          aequator.add("<p><b>" + ewm.vorname + " " + ewm.nachname + "</b><br>Jahrgang: "
              + ewm.jahrgang + "<br>Kilometer: " + km + "<br>" + anzAeq + ". Äquatorpreis</p>");
        } else {
          warnings++;
        }
      }
    ...
    try {
      ...
      f.write("<p><b>Verein: " + ew.verein_name + "</b><br>Mitgliedsnummer: " + ew.verein_mitglnr
          + "<br><br>Anschrift:<br>" + ew.versand_name + "<br>" + ew.versand_strasse + "<br>"
          + ew.versand_ort + "</p>\n");
