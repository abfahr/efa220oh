...
public class PDFOutput {
  ...
  private static String getAbzeichenList(String abzeichenListe) {
    ...
    for (int i = 0; i < a.length; i++) {
      if (a[i] > 0) {
        einzeln += (einzeln.length() > 0 ? "; " : "") + a[i] + " x " + ((i + 1) * 5) + ". "
            + abzeichenText;
      }
    }
    if (a.length == 1) {
      einzeln = null; // wenn noch altes Format, d.h. keine Information über Anzahl der einzelnen
      // Abzeichen
    }
    return gold + (einzeln != null ? " (" + einzeln + ")" : "");
  }

  private static void writeRow(BufferedWriter f, String field, String value, String fontSize)
      throws IOException {
    f.write("                  <fo:table-row>\n");
    f.write("                    <fo:table-cell border=\"0.5pt #000000 solid\" padding-left=\"1pt\"><fo:block>"
        + field + "</fo:block></fo:table-cell>\n");
    f.write("                    <fo:table-cell border=\"0.5pt #000000 solid\" padding-left=\"1pt\"><fo:block font-size=\""
        + fontSize + "\">" + value + "</fo:block></fo:table-cell>\n");
    f.write("                  </fo:table-row>\n");
  }

  public static void printPDFbestaetigung(DRVConfig drvConfig, EfaWett ew, String qnr,
      int meldegeld,
    ...
    try {
      String header = EfaUtil.saveImage("DRV_Briefkopf_header.gif", "gif", Daten.efaTmpDirectory,
          true, true, true);
      String footer = EfaUtil.saveImage("DRV_Briefkopf_footer.gif", "gif", Daten.efaTmpDirectory,
          true, true, true);
      String fontSize = "10pt";
      String smallFontSize = "9pt";

      int netto = (meldegeld * 100) / 107;
      int mwst = meldegeld - netto;
      BufferedWriter f = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(xslfo),
          Daten.ENCODING_UTF));
       ...
       * f.write("              <fo:external-graphic src=\"url('" + header +
       * "')\" width=\"210mm\" height=\"42mm\" />\n"); f.write("    </fo:static-content>\n");
       * f.write("    <fo:static-content flow-name=\"xsl-region-after\" >\n");
       * f.write("              <fo:external-graphic src=\"url('" + footer +
       * "')\" width=\"210mm\" height=\"30mm\" />\n"); f.write("    </fo:static-content>\n");
       */
      f.write("    <fo:static-content flow-name=\"xsl-region-before\" >\n");
      f.write("        <fo:block>\n");
      f.write("              <fo:external-graphic src=\"url('" + header
          + "')\" content-width=\"210mm\" content-height=\"42mm\" />\n");
      f.write("        </fo:block>\n");
      f.write("    </fo:static-content>\n");
      ...
      f.write("        <fo:block>\n");
      f.write("              <fo:external-graphic src=\"url('" + footer
          + "')\" content-width=\"210mm\" content-height=\"30mm\" />\n");
      f.write("        </fo:block>\n");
      f.write("    </fo:static-content>\n");

      f.write("    <fo:flow font-family=\"Helvetica\" font-size=\"" + fontSize
      ...
      f.write("               <fo:block font-size=\"" + fontSize
          + "\" font-weight=\"bold\"  space-before=\"5mm\">Meldung für das DRV-Fahrtenabzeichen "
          + drvConfig.aktJahr + "</fo:block>\n");
      f.write("               <fo:block font-size=\"" + fontSize
          + "\" font-weight=\"bold\">Verein: " + ew.verein_name + "</fo:block>\n");
      f.write("               <fo:block font-size=\"" + fontSize
          + "\" font-weight=\"bold\">Mitgliedsnummer: " + ew.verein_mitglnr + "</fo:block>\n");
      f.write("               <fo:block font-size=\"" + fontSize
          + "\" font-weight=\"bold\">Rechnungs- und Bestätigungsnummer: " + qnr + "</fo:block>\n");
      f.write("            </fo:table-cell>\n");
      f.write("            <fo:table-cell height=\"25mm\">\n");
      f.write("               <fo:block font-size=\"" + fontSize + "\">"
          + EfaUtil.getCurrentTimeStampDD_MM_YYYY() + "</fo:block>\n");
      f.write("            </fo:table-cell>\n");
      f.write("	         </fo:table-row>\n");
      f.write("	       </fo:table-body>\n");
      f.write("      </fo:table>\n");
      ...
      f.write("      <fo:block space-before=\"4mm\">zu der erfolgreichen Teilnahme "
          + (gewertet == 1 ? "Ihres Mitglieds" : "Ihrer Mitglieder")
          + " am Fahrtenwettbewerb " + drvConfig.aktJahr
          + " gratulieren wir Ihnen sehr herzlich.</fo:block>\n");
      ...
      f.write("            <fo:list-item-body start-indent=\"50mm\"><fo:block>" + gemeldet
          + "</fo:block></fo:list-item-body>\n");
      f.write("          </fo:list-item>\n");
      f.write("          <fo:list-item>\n");
      f.write("            <fo:list-item-label><fo:block>Gewertete Teilnehmer:</fo:block></fo:list-item-label>\n");
      f.write("            <fo:list-item-body start-indent=\"50mm\"><fo:block>" + gewertet + " ("
          + erwachsene + " Erwachsene, " + jugendliche
          + " Jugendliche)</fo:block></fo:list-item-body>\n");
      f.write("          </fo:list-item>\n");
      ...
      if (gewertet < gemeldet && nichtGewerteteTeilnehmer.size() > 0) {
        ...
        for (int i = 0; i < nichtGewerteteTeilnehmer.size(); i++) {
          ...
          f.write("            <fo:list-item-body start-indent=\"5mm\"><fo:block>"
              + nichtGewerteteTeilnehmer.get(i) + "</fo:block></fo:list-item-body>\n");
          f.write("          </fo:list-item>\n");
        }
        f.write("      </fo:list-block>\n");
      }
      ...
      if (ew.drvint_anzahlPapierFahrtenhefte > 0) {
        f.write("          <fo:list-item>\n");
        f.write("            <fo:list-item-label><fo:block>-</fo:block></fo:list-item-label>\n");
        f.write("            <fo:list-item-body start-indent=\"5mm\"><fo:block>eingesandte Papier-Fahrtenhefte ("
            + ew.drvint_anzahlPapierFahrtenhefte + " Hefte)</fo:block></fo:list-item-body>\n");
        f.write("          </fo:list-item>\n");
      }
      String s = "";
      int nadelnCount = EfaUtil.sumUpArray(EfaUtil.kommaList2IntArr(ew.drv_nadel_erw_gold, ','))
          + EfaUtil.string2int(ew.drv_nadel_erw_silber, 0)
          + EfaUtil.sumUpArray(EfaUtil.kommaList2IntArr(ew.drv_nadel_jug_gold, ','))
          + EfaUtil.string2int(ew.drv_nadel_jug_silber, 0);
      if (nadelnCount > 0) {
        f.write("          <fo:list-item>\n");
        f.write("            <fo:list-item-label><fo:block>-</fo:block></fo:list-item-label>\n");
        f.write("            <fo:list-item-body start-indent=\"5mm\"><fo:block>" + nadelnCount
            + " Anstecknadeln:</fo:block></fo:list-item-body>\n");
        f.write("          </fo:list-item>\n");
        if (EfaUtil.sumUpArray(EfaUtil.kommaList2IntArr(ew.drv_nadel_erw_gold, ',')) > 0) {
          ...
          f.write("            <fo:list-item-body start-indent=\"50mm\"><fo:block>" + abzeichenList
              + "</fo:block></fo:list-item-body>\n");
          f.write("          </fo:list-item>\n");
        }
        if (EfaUtil.string2int(ew.drv_nadel_erw_silber, 0) > 0) {
          ...
          f.write("            <fo:list-item-body start-indent=\"50mm\"><fo:block>"
              + ew.drv_nadel_erw_silber + "</fo:block></fo:list-item-body>\n");
          f.write("          </fo:list-item>\n");
        }
        ...
        if (EfaUtil.string2int(ew.drv_nadel_jug_silber, 0) > 0) {
          ...
          f.write("            <fo:list-item-body start-indent=\"50mm\"><fo:block>"
              + ew.drv_nadel_jug_silber + "</fo:block></fo:list-item-body>\n");
          f.write("          </fo:list-item>\n");
        }
      ...
      f.write("      <fo:block space-before=\"4mm\">Für das Meldegeld"
          + s
          + " ergibt sich eine Summe in Höhe von "
          + EfaUtil.cent2euro(meldegeld, true)
          + " (Nettobetrag "
          + EfaUtil.cent2euro(netto, true)
          + " zzgl. "
          + EfaUtil.cent2euro(mwst, true)
          + " gesetzl. MwSt. 7% gem. § 12 Abs. 8 UStG). "
      ...
      for (int i = 0; i < v.size(); i++) {
        ...
        f.write("              <fo:block font-size=\"14pt\" font-weight=\"bold\" text-align=\"center\">für "
            + sig.getVorname() + " " + sig.getNachname() + "</fo:block>\n");
        ...
        writeRow(f, "Kilometer " + Integer.toString(sig.getJahr()) + ":",
            Integer.toString(sig.getLetzteKm()), fontSize);
        ...
        writeRow(f, "elektronisches Fahrtenheft (zur Eingabe):",
            EfaUtil.replace(EfaUtil.replace(sig.toString(), ";", "~~~~~", true), "~~~~~", "; ",
                true),
                smallFontSize);
        f.write("                </fo:table-body>\n");
        f.write("              </fo:table>\n");
    ...
    if (res != null) {
      ...
      if (drvConfig.acrobat.length() > 0) {
        try {
          ...
          Dialog.error("Fehler: Acrobat Reader '" + drvConfig.acrobat
