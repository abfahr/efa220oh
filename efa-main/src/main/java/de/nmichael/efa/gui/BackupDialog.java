...
public class BackupDialog extends BaseTabbedDialog implements IItemListener {
  ...
  public void itemListenerAction(IItemType itemType, AWTEvent event) {
    ...
    if ((itemType.getName().equals(RESTORE_SELECT_CONFIG) ||
      ...
      selectItems(restoreArchiveContents, restoreSelectConfig.getValue(),
          restoreSelectProject.getValue());
    }
    ...
    if (itemType.getName().equals(RESTORE_BUTTON) && event instanceof ActionEvent) {
          ...
          if (meta != null && Backup.isProjectDataAccess(meta.getType())
            ...
            if (Dialog
                .yesNoCancelDialog(
                    ...
                    International
                    .getString("Du hast nicht alle Projektdaten zur Wiederherstellung ausgewählt. "
      ...
      if (containsProjectData && prjName != null
          && !prjName.equals(restoreMetaData.getProjectName())) {
        if (Dialog
            .yesNoCancelDialog(
                International.getString("Backup einspielen"),
                International
                .getMessage(
                    ...
                    + International.getMessage(
                        "Möchtest Du das Projekt {name} öffnen oder neu erstellen?",
  ...
  private void readBackupContent() {
    ...
    if (restoreMetaData.read(restoreZipFile.getValue())) {
      ...
      Dialog.error(International
          .getString("ZIP-Archiv kann nicht gelesen werden oder ist kein gültiges Backup."));
