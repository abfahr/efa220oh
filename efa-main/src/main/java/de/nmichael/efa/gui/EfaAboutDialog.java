...
public class EfaAboutDialog extends BaseDialog {
  ...
  protected void iniDialog() throws Exception {
    ...
    copyLabel.setText("Copyright (c) 2001-" + Daten.COPYRIGHTYEAR + " by Nicolas Michael"); // do
    // not
    // internationalize
     ...
     * emailLabel.setForeground(Color.blue); emailLabel.setText(Daten.EMAILINFO);
     * emailLabel.addMouseListener(new java.awt.event.MouseAdapter() { public void
     * mouseEntered(MouseEvent e) { label_mouseEntered(e); } public void mouseExited(MouseEvent e) {
     * label_mouseExited(e); } public void mouseClicked(MouseEvent e) { emailLabel_mouseClicked(e);
     * } });
     */
    ...
    infoPanel.add(logoLabel, new GridBagConstraints(0, 0, 1, 7, 0.0, 0.0, GridBagConstraints.NORTH,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 20), 0, 0));
    infoPanel.add(nameLabel, new GridBagConstraints(1, 0, 4, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 93, 0));
    infoPanel.add(versionLabel, new GridBagConstraints(1, 1, 4, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 5, 0), 230, 0));
    infoPanel.add(languageLabel, new GridBagConstraints(1, 2, 4, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 20, 0), 230, 0));
    infoPanel.add(copyLabel, new GridBagConstraints(1, 3, 4, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 20, 0), 65, 0));
    infoPanel.add(urlLabel0, new GridBagConstraints(1, 4, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 1, 0));
    infoPanel.add(urlLabel, new GridBagConstraints(2, 4, 3, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 1, 0));
    infoPanel.add(supportLabel0, new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 1, 0));
    infoPanel.add(supportLabel, new GridBagConstraints(2, 5, 3, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 1, 0));
    // infoPanel.add(emailLabel0, new GridBagConstraints(1, 6, 1, 1, 0.0, 0.0,
    // GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 20, 0), 0, 0));
    // infoPanel.add(emailLabel, new GridBagConstraints(2, 6, 3, 1, 0.0, 0.0,
    // GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 20, 0), 0, 0));
    infoPanel.add(gpl1Label, new GridBagConstraints(1, 7, 2, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 20, 0), 0, 0));
    infoPanel.add(gplLabel, new GridBagConstraints(3, 7, 2, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 20, 20), 0, 0));
    infoPanel.add(devNoteLabel, new GridBagConstraints(1, 8, 4, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 20), 0, 0));
    infoPanel.add(efaBirthdayLabel, new GridBagConstraints(0, 11, 4, 1, 0.0, 0.0,
    ...
    try {
      ...
      for (int i = 0; bundles != null && i < bundles.length; i++) {
        ...
        International.getString("+++TRANSLATED_BY+++"); // dummy, just to make make_i18n_keys.pl
        // find this key ;)
        try {
  ...
  void gplLabel_mouseClicked(MouseEvent e) {
    BrowserDialog.openInternalBrowser(this, "Browser", "file:"
        // TODO 2020-09-25 abf besseres internes directory finden
        + Daten.EFA_LICENSE,
        700, 600);
  }
