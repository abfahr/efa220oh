...
public class EfaExitFrame extends BaseFrame {
  ...
  protected void iniDialog() throws Exception {
    ...
    jPanel1.add(jLabel0, new GridBagConstraints(0, 0, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
    ...
    jPanel1.add(jLabel3, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
        GridBagConstraints.NONE, new Insets(5, 0, 0, 20), 0, 0));
    ...
    if (_exit) {
      ...
      Logger.log(Logger.INFO, Logger.MSG_EVT_EFAEXIT,
          ...
          + (restart ? " " + International.getString("und wird anschließend neu gestartet")
              + "."
              : "."));
      // disable window stack checks: EfaBoathouseFrame may not be top of stack; yet we're closing
      // it
