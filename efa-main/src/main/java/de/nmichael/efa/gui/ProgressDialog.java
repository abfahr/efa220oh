...
public class ProgressDialog extends BaseDialog {
  ...
  protected void iniDialog() throws Exception {
    ...
    progressPanel
    .add(progressBar, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0
        , GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 10, 5, 10),
        0, 0));
  ...
  public void logInfo(String s) {
    for (int tryi = 1; loggingTextArea == null && currentStatusLabel == null && tryi <= 10; tryi++) {
      ...
      } catch (Exception e) {} // Dialog may not have been fully initialized when progress thread
      // starts running
    }
    if (loggingTextArea != null) {
