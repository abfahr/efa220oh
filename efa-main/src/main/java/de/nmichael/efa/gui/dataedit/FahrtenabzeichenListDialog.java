...
public class FahrtenabzeichenListDialog extends DataListDialog {
  ...
  public static final int ACTION_GETFAHRTENHEFTE = 901; // negative actions will not be shown as
  // popup actions
                ...
                "Bestätigungsdatei aus Internet herunterladen", "vorhandene Bestätigungsdatei einlesen")) {
                  case 0:
                    ...
                    String request = EfaWettClient.makeScriptRequestString(EfaWettClient.VERBAND_DRV,
                        EfaWettClient.ACTION_QNRLIST, null, null);
                    if (request == null) {
                    ...
                    try {
                      BufferedReader f = new BufferedReader(new InputStreamReader(
                          new FileInputStream(localFile), Daten.ENCODING_ISO));
                      String s;
                      String[] qnr = null;
                      String[] wett = null;
                      ...
                      if (qnr == null || wett == null) {
                        Dialog
                        .error("Es konnten keine Bestätigungsdateien gefunden werden!\n"
                      ...
                      Dialog
                      .error("Die heruntergeladene Liste der Quittungsnummern konnte nicht geöffnet werden: "
                          + e.toString());
                      return false;
                    }
