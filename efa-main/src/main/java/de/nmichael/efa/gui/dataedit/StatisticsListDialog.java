...
public class StatisticsListDialog extends DataListDialog {
  ...
  public static final int ACTION_CREATESTATISTICS = 901; // negative actions will not be shown as
  // popup actions
  public static final int ACTION_ONETIMESTATISTIC = 902; // negative actions will not be shown as
  // popup actions
  public static final int ACTION_MOVEUP = 1001; // positive actions > 2000 will be shown as popups +
  // small buttons without text
  public static final int ACTION_MOVEDOWN = 1002; // positive actions > 2000 will be shown as popups
  // + small buttons without text
  ...
  public void itemListenerActionTable(int actionId, DataRecord[] records) {
    ...
    switch (actionId) {
      ...
      case ACTION_ONETIMESTATISTIC:
        StatisticsRecord srtmp = Daten.project.getStatistics(false)
        .createStatisticsRecord(UUID.randomUUID());
