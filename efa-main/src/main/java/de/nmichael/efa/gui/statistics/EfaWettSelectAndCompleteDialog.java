...
public class EfaWettSelectAndCompleteDialog extends BaseDialog implements ActionListener {
  ...
  protected void iniDialog() throws Exception {
    ...
    jPanel1.add(teilnLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teilnAnz, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln1Label, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln2Label, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln3Label, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln4Label, new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    ...
    jPanel1.add(gebLabel, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(teiln1Anz, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln2Anz, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln3Anz, new GridBagConstraints(1, 4, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln4Anz, new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    ...
    jPanel1.add(gebuehrLabel, new GridBagConstraints(2, 0, 2, 1, 0.0, 0.0,
        GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(geb1Label, new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(geb, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(geb1, new GridBagConstraints(3, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(geb2, new GridBagConstraints(3, 3, 2, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(geb2Label, new GridBagConstraints(2, 3, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(bestellungenLabel, new GridBagConstraints(5, 0, 3, 1, 0.0, 0.0,
        GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(bestLabel1, new GridBagConstraints(5, 2, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(best, new GridBagConstraints(6, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(bestLabel2, new GridBagConstraints(5, 3, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(bestLabel3, new GridBagConstraints(5, 4, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(bestLabel4, new GridBagConstraints(5, 5, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(bestLabel5, new GridBagConstraints(5, 6, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(best4, new GridBagConstraints(6, 5, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(best3, new GridBagConstraints(6, 4, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(best2, new GridBagConstraints(6, 3, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(best1, new GridBagConstraints(6, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(bestLabel6, new GridBagConstraints(5, 7, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(bestLabel, new GridBagConstraints(5, 1, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(best5, new GridBagConstraints(6, 6, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(best6, new GridBagConstraints(6, 7, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln5Label, new GridBagConstraints(0, 7, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln5Anz, new GridBagConstraints(1, 7, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

    labelFelder(efaWett);
    iniFelder(efaWett);
    teilnehmerScrollPane.setMaximumSize(new Dimension((int) Dialog.screenSize.getWidth() - 100,
        (int) Dialog.screenSize.getHeight() - 300));
    teilnehmerScrollPane.setPreferredSize(new Dimension((int) Dialog.screenSize.getWidth() - 100,
        (int) Dialog.screenSize.getHeight() - 300));
  ...
  void labelFelder(EfaWett ew) {
    ...
    if (ew.wettId != WettDefs.DRV_FAHRTENABZEICHEN) {
      if (ew.wettId == WettDefs.DRV_WANDERRUDERSTATISTIK) {
        jLabelTitel
        .setText("Bitte markiere alle Wanderfahrten, die für den Wettbewerb gemeldet werden sollen:");
      }
      ...
      if (ew.wettId == WettDefs.LRVBERLIN_BLAUERWIMPEL
          || ew.wettId == WettDefs.DRV_WANDERRUDERSTATISTIK) {
  ...
  void addField(EfaWettMeldung m, int content, int type, String text, int x, int y, int width,
      int height, int align, Color color, boolean checked) {
    switch (type) {
      case T_LABEL:
        JLabel l = new JLabel();
        l.setText(text);
        ...
        dataPanel.add(l, new GridBagConstraints(x, y, 1, 1, 0.0, 0.0, align,
      ...
      case T_CHECKBOX:
        ...
        dataPanel.add(c, new GridBagConstraints(x, y, 1, 1, 0.0, 0.0, align,
            GridBagConstraints.NONE, new Insets(0, 10, 0, 10), 0, 0));
      ...
      case T_TEXTFIELD:
        ...
        dataPanel.add(t, new GridBagConstraints(x, y, 1, 1, 0.0, 0.0, align,
            GridBagConstraints.NONE, new Insets(0, 10, 0, 10), 0, 0));
  ...
  void addLink(EfaWettMeldung m, int content, int type, String text, int x, int y, int width,
      int height, int align, boolean checked) {
    switch (type) {
      case T_LABEL:
        JLabel l = new JLabel();
        l.setText(text);
  ...
  void iniFelder(EfaWett ew) {
    ...
    if (displayAbzeichen) {
      addField(null, 0, T_LABEL, "Anstecknadel", x++, y, 0, 0, GridBagConstraints.CENTER, null,
          false);
    }
    if (displayAbzeichen) {
      addField(null, 0, T_LABEL, "Stoffabzeichen", x++, y, 0, 0, GridBagConstraints.CENTER, null,
          false);
    }
    if (ew.wettId == WettDefs.DRV_FAHRTENABZEICHEN) {
      addField(null, 0, T_LABEL, "Bemerkungen", x++, y, 0, 0, GridBagConstraints.CENTER, null,
          false);
    }
    ...
    while (m != null) {
      ...
      if (displayLfdNr) {
        if (m.drvWS_LfdNr != null && m.drvWS_LfdNr.length() > 0 &&
          ...
          addField(m, 0, T_LABEL, (m.drvWS_LfdNr != null ? m.drvWS_LfdNr : ""), x++, y, 0, 0,
              GridBagConstraints.EAST, Color.black, false);
        }
      }

      // Name (Label)
      if (ew.wettId != WettDefs.DRV_WANDERRUDERSTATISTIK) {
        addField(m, 0, T_LABEL, (m.vorname != null ? m.vorname + " " : "")
            + (m.nachname != null ? m.nachname : ""), x++, y, 0, 0, GridBagConstraints.WEST,
            Color.black, false);
      } else {
        addField(m, 0, T_LABEL,
            (m.drvWS_StartZiel != null ? EfaUtil.trimto(m.drvWS_StartZiel, 40, true) : ""), x++, y,
            0, 0, GridBagConstraints.WEST, Color.black, false);
      }
      ...
      if (displayGruppe) {
        ...
        addField(m, 0, T_LABEL, (gruppe != null ? gruppe + " " : "")
            + (m.jahrgang != null ? "(" + m.jahrgang
                + (m.geschlecht != null ? "; " + m.geschlecht : "") + ")" : ""),
      ...
      if (displayStrecke) {
        addField(m, 0, T_LABEL,
            (m.drvWS_Strecke != null ? EfaUtil.trimto(m.drvWS_Strecke, 30, true) : ""), x++, y, 0,
            0, GridBagConstraints.WEST, Color.black, false);
      }

      // Gewaesser (Label)
      if (displayGewaesser) {
        addField(m, 0, T_LABEL,
            (m.drvWS_Gewaesser != null ? EfaUtil.trimto(m.drvWS_Gewaesser, 25, true) : ""), x++, y,
            0, 0, GridBagConstraints.WEST, Color.black, false);
      }

      // Tage (Label)
      if (displayTage) {
        addField(m, 0, T_LABEL, (m.drvWS_Tage != null ? m.drvWS_Tage : ""), x++, y, 0, 0,
            GridBagConstraints.CENTER, Color.black, false);
      }
      ...
      if (displayKm) {
        ...
        addField(m, 0, T_LABEL, (km != null ? km : ""), x++, y, 0, 0, GridBagConstraints.CENTER,
            Color.black, false);
      }

      // Teilnehmer (Label)
      if (displayTeilnehmer) {
        addField(m, 0, T_LABEL, (m.drvWS_Teilnehmer != null ? m.drvWS_Teilnehmer : ""), x++, y, 0,
            0, GridBagConstraints.CENTER, Color.black, false);
      }

      // Anschrift (Textfield)
      if (displayAnschrift) {
        if (m.anschrift != null) {
          addField(m, C_ANSCHRIFT, T_TEXTFIELD, m.anschrift, x++, y, 200, 19,
              GridBagConstraints.WEST, null, false);
        } else {
          x++;
        }
      }
      ...
      if (displayDRVFahrtenheft) {
        ...
        if (drvSignatur != null) {
          ...
          if (m.drv_anzAbzeichenAB != null && EfaUtil.string2int(m.drv_anzAbzeichenAB, 0) > 0
              && displayAB) {
      ...
      if (displayAbzeichen) {
        if (m.abzeichen != null) {
          ...
          addField(m, C_BESTELLEN1, T_CHECKBOX, s, x++, y, 0, 0, GridBagConstraints.CENTER, null,
              abzSelected);

          if (m.abzeichen.startsWith(EfaWettMeldung.ABZEICHEN_ERW_GOLD_PRAEFIX)
              || m.abzeichen.equals(EfaWettMeldung.ABZEICHEN_JUG_EINF)
              || m.abzeichen.startsWith(EfaWettMeldung.ABZEICHEN_JUG_GOLD_PRAEFIX)) {
            addField(m, C_BESTELLEN2, T_CHECKBOX, "bestellen", x++, y, 0, 0,
                GridBagConstraints.CENTER, null, false);
          } else {
            addField(null, 0, T_LABEL, "nur bei Gold", x++, y, 0, 0, GridBagConstraints.CENTER,
                null, false);
          }
        }
      }
  ...
  Hashtable getSelectedMeldungen() {
    ...
    for (Object checkKey : checkKeys) {
      if (((JCheckBox) checkKey).isSelected()
          && ((Item) checkboxes.get(checkKey)).content == C_MELDEN) {
        gemeldete.put(((Item) checkboxes.get(checkKey)).m, "dummy");
      }
    }
    return gemeldete;
  }
  ...
  void calculateValues() {
    ...
    for (Object checkKey : checkKeys) {
      Item item = (Item) checkboxes.get(checkKey);
      JCheckBox c = (JCheckBox) checkKey;
      switch (item.content) {
        case C_MELDEN:
          if (c.isSelected()) {
            anzMelden++;
            switch (efaWett.wettId) {
              ...
              case WettDefs.LRVBERLIN_BLAUERWIMPEL:
                ...
                anzMelden2 += EfaUtil.zehntelString2Int(item.m.kilometer); // Gesamtkilometer der zu
                // meldenden Teilnehmer
                break;
            }
          }
          break;
    ...
    for (Object textfKey : textfKeys) {
      Item item = (Item) textfields.get(textfKey);
      JTextField t = (JTextField) textfKey;
      if (gemeldete.get(item.m) != null) {
        t.setEnabled(true);
      } else {
        t.setEnabled(false);
    ...
    if (efaWett.wettId == WettDefs.DRV_WANDERRUDERSTATISTIK) {
      this.teilnAnz.setText(Integer.toString(
          EfaUtil.string2int(efaWett.aktive_M_ab19, 0)
          + EfaUtil.string2int(efaWett.aktive_M_bis18, 0)
          + EfaUtil.string2int(efaWett.aktive_W_ab19, 0)
          + EfaUtil.string2int(efaWett.aktive_W_bis18, 0)));
    ...
    this.best.setText(EfaUtil.cent2euro(gebBestellSumme1, true)
        + (gebBestellSumme2 > 0 ? " + " + EfaUtil.cent2euro(gebBestellSumme2, true) : ""));
    this.best1.setText(anzBestellErwEinf + " x " + EfaUtil.cent2euro(gebProBestell1, true));
    this.best2.setText(EfaUtil.sumUpArray(anzBestellErwGold) + " x "
        + EfaUtil.cent2euro(gebProBestell2, true));
    this.best3.setText(anzBestellJugEinf + " x " + EfaUtil.cent2euro(gebProBestell3, true));
    this.best4.setText(EfaUtil.sumUpArray(anzBestellJugGold) + " x "
        + EfaUtil.cent2euro(gebProBestell4, true));
  ...
  public void closeButton_actionPerformed(ActionEvent e) {
    if (Logger.isTraceOn(Logger.TT_STATISTICS)) {
      Logger.log(Logger.DEBUG, Logger.MSG_DEBUG_STATISTICS,
          "EfaWettSelectAndCompleteFrame.okButton_actionPerformed(e) - START");
    }
    ...
    if (Logger.isTraceOn(Logger.TT_STATISTICS)) {
      Logger.log(Logger.DEBUG, Logger.MSG_DEBUG_STATISTICS,
          "EfaWettSelectAndCompleteFrame.okButton_actionPerformed(e): gemeldete.size() == "
              + gemeldete.size());
    }
    if (gemeldete.size() == 0) {
    ...
    while (m != null) {
      if (gemeldete.get(m) == null) {
        ...
        if (Logger.isTraceOn(Logger.TT_STATISTICS)) {
          Logger.log(Logger.DEBUG, Logger.MSG_DEBUG_STATISTICS,
              "EfaWettSelectAndCompleteFrame.okButton_actionPerformed(e): Meldung m == "
    ...
    if (Logger.isTraceOn(Logger.TT_STATISTICS)) {
      Logger.log(Logger.DEBUG, Logger.MSG_DEBUG_STATISTICS,
          "EfaWettSelectAndCompleteFrame.okButton_actionPerformed(e) - END");
    }
