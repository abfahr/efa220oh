...
public class EfaMouseListener extends MouseAdapter {
  ...
  public EfaMouseListener(Component myComponent, JPopupMenu popupMenu,
      ActionListener actionListener, boolean showPopupOnLeftMouseClick) {
  ...
  public void mouseReleased(MouseEvent e) {
    ...
    if (e != null && e.getButton() == 1) {
      if (e.getClickCount() == 1) {
        ...
        actionListener.actionPerformed(new ActionEvent(e.getSource(), ActionEvent.ACTION_PERFORMED,
            EVENT_MOUSECLICKED_1x));
      }
      if (e.getClickCount() == 2) {
        actionListener.actionPerformed(new ActionEvent(e.getSource(), ActionEvent.ACTION_PERFORMED,
            EVENT_MOUSECLICKED_2x));
      }
    } else {
      maybeShowPopup(e);
    }
      ...
      if (popupsEnabled && e.isPopupTrigger()) {
        ...
        if (actionListener != null) {
          actionListener.actionPerformed(new ActionEvent(e.getSource(),
              ActionEvent.ACTION_PERFORMED, EVENT_POPUP));
        }
      }
