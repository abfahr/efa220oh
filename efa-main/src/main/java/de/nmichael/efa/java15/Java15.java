...
public class Java15 {
  ...
  public static boolean editorPaneHandlePostEvent(javax.swing.JEditorPane editorPane,
    ...
    try {
      ...
      java.net.HttpURLConnection conn = (java.net.HttpURLConnection) (fevent.getURL())
          .openConnection();
    ...
    try {
      try {
        ...
        for (int i = 0; i < pools.size(); i++) {
          ...
          if (de.nmichael.efa.util.Logger
              .isTraceOn(de.nmichael.efa.util.Logger.TT_MEMORYSUPERVISION)) {
            ...
            de.nmichael.efa.util.Logger.log(
                de.nmichael.efa.util.Logger.DEBUG,
                de.nmichael.efa.util.Logger.MSG_DEBUG_MEMORYSUPERVISOR,
                "MemorySupervisor:   Usage after last GC: "
                    + printMemUsage(pool.getCollectionUsage()));
            de.nmichael.efa.util.Logger.log(de.nmichael.efa.util.Logger.DEBUG,
                de.nmichael.efa.util.Logger.MSG_DEBUG_MEMORYSUPERVISOR,
          ...
          if (pool.getName().toLowerCase().indexOf("tenured") >= 0
            ...
            if (usage.getMax() > 0 && (usage.getUsed() * 100) / usage.getMax() >= percentageHigh) {
              ...
              de.nmichael.efa.util.Logger.log(de.nmichael.efa.util.Logger.WARNING,
                  ...
                  "MemorySupervisor:   Current Usage      : " + printMemUsage(pool.getUsage()));
              de.nmichael.efa.util.Logger.log(
                  de.nmichael.efa.util.Logger.WARNING,
                  de.nmichael.efa.util.Logger.MSG_WARN_MEMORYSUPERVISOR,
                  "MemorySupervisor:   Usage after last GC: "
                      + printMemUsage(pool.getCollectionUsage()));
              de.nmichael.efa.util.Logger.log(de.nmichael.efa.util.Logger.WARNING,
            ...
            } else if (usage.getMax() > 0
                && (usage.getUsed() * 100) / usage.getMax() >= percentageRelativelyHigh
                && !memoryWarningLow) {
              de.nmichael.efa.util.Logger.log(
                  de.nmichael.efa.util.Logger.WARNING,
                  de.nmichael.efa.util.Logger.MSG_WARN_MEMORYSUPERVISOR,
                  "MemorySupervisor: "
                      + de.nmichael.efa.util.International
                      .getString("Der aktuelle Speicherverbrauch ist relativ hoch."));
              de.nmichael.efa.util.Logger.log(de.nmichael.efa.util.Logger.WARNING,
                  de.nmichael.efa.util.Logger.MSG_WARN_MEMORYSUPERVISOR,
                  "MemorySupervisor: Memory Pool: " + pool.getName());
              de.nmichael.efa.util.Logger.log(de.nmichael.efa.util.Logger.WARNING,
              ...
              de.nmichael.efa.util.Logger.log(de.nmichael.efa.util.Logger.WARNING,
                  de.nmichael.efa.util.Logger.MSG_WARN_MEMORYSUPERVISOR,
                  "MemorySupervisor:   Peak Usage         : " + printMemUsage(pool.getPeakUsage()));
              de.nmichael.efa.util.Logger
              .log(
                  de.nmichael.efa.util.Logger.WARNING,
                  de.nmichael.efa.util.Logger.MSG_WARN_MEMORYSUPERVISOR,
                  "MemorySupervisor: "
                      + de.nmichael.efa.util.International
                      .getString("Der efa zur Verfügung stehende Arbeitsspeicher kann durch eine Konfigurationsdatei hochgesetzt werden (siehe efa-FAQ)."));
              memoryWarningLow = true;
            } else {
              if (usage.getMax() > 0
                  && (usage.getUsed() * 100) / usage.getMax() < percentageRelativelyHigh
                ...
                de.nmichael.efa.util.Logger
                .log(
                    de.nmichael.efa.util.Logger.INFO,
                    de.nmichael.efa.util.Logger.MSG_EVT_MEMORYSUPERVISOR,
                    "MemorySupervisor: "
                        + de.nmichael.efa.util.International
                        .getString("Der aktuelle Speicherverbrauch ist wieder im unkritischen Bereich."));
                ...
                de.nmichael.efa.util.Logger.log(de.nmichael.efa.util.Logger.INFO,
                    de.nmichael.efa.util.Logger.MSG_EVT_MEMORYSUPERVISOR,
                    "MemorySupervisor:   Peak Usage         : "
                        + printMemUsage(pool.getPeakUsage()));
      ...
      if (de.nmichael.efa.util.Logger.isTraceOn(de.nmichael.efa.util.Logger.TT_MEMORYSUPERVISION)) {
        de.nmichael.efa.util.Logger.log(de.nmichael.efa.util.Logger.DEBUG,
            de.nmichael.efa.util.Logger.MSG_DEBUG_MEMORYSUPERVISOR,
            "Could not determine Memory Usage: " + ee.toString()
            + " (only supported for Java 1.5 and higher)");
      }
    }
    return memoryLow;
  }
