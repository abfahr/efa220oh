...
public class StatisticPDFWriter extends StatisticXMLWriter {
  ...
  public boolean write() {
    ...
    // transform XML
    try {
      javax.xml.transform.TransformerFactory trfac = javax.xml.transform.TransformerFactory
          .newInstance();
      javax.xml.transform.Transformer trans;
      trans = trfac.newTransformer(new javax.xml.transform.stream.StreamSource(new File(
          xslOutputFile)));
      trans.transform(new javax.xml.transform.stream.StreamSource(new File(xmlOutputFile)),
          new javax.xml.transform.stream.StreamResult(new File(foOutputFile)));
    } catch (Exception e) {
    ...
    if (Daten.efaConfig.getValueAcrobat() != null &&
      ...
      try {
        ...
        Logger.logdebug(e);
        Dialog.error(LogString.cantExecCommand(Daten.efaConfig.getValueAcrobat(), "Acrobat Reader",
