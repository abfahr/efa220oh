 ...
 * href="http://iharder.net/xmlizable">http://iharder.net/base64</a> periodically to check for
...
public class Base64
{
  ...
  /**
   * Encodes the first three bytes of array <var>threeBytes</var> and returns a four-byte array in
   * Base64 notation.
   *
  ...
  /**
   * Decodes the first four bytes of array <var>fourBytes</var> and returns an array up to three
   * bytes long with the decoded values.
   *
  ...
  /**
   * A {@link Base64#InputStream} will read data from another {@link java.io.InputStream}, given in
  ...
  /**
   * A {@link Base64#OutputStream} will write data to another {@link java.io.OutputStream}, given in
   * the constructor, and encode/decode to/from Base64 notation on the fly.
   *
   * @see Base64
