...
public class HtmlFactory {
  ...
  public static BufferedWriter createFile(String filename) {
    try {
      return new BufferedWriter(new OutputStreamWriter(new FileOutputStream(filename, false),
          Daten.ENCODING_UTF));
    } catch (Exception e) {
      Logger.logdebug(e);
      return null;
  ...
  public static String createMailto(String email) {
    ...
    try {
      ...
      f.write("<input type=\"hidden\" name=\"reply_mailsent\" value=\""
          + International.getString("email erfolgreich versandt.") + "\">\n");
  ...
  public static String createRegister() {
    ...
    try {
      ...
      f.write("<tr><td rowspan=\"2\" valign=\"top\"><b>"
          + International.getString("Benutzt für Sportarten") + ":</b></td>");
      f.write("<td colspan=\"3\"><input name=\"useRowing\" type=\"checkbox\" value=\"yes\" "
          + checkedRowing + " /> "
          + International.getString("Rudern") + "</td></tr>\n");
      f.write("<tr><td colspan=\"3\"><input name=\"useCanoeing\" type=\"checkbox\" value=\"yes\" "
          + checkedCanoeing + " />"
      ...
      f.write("<td colspan=\"3\"><input name=\"name\" type=\"text\" value=\"" + adminName
          + "\" size=\"40\"/></td></tr>\n");

      f.write("<tr><td><b>" + International.getString("email-Adresse") + ":</b></td>");
      f.write("<td colspan=\"3\"><input name=\"email\" type=\"text\" value=\"" + adminEmail
          + "\" size=\"40\"/></td></tr>\n");
