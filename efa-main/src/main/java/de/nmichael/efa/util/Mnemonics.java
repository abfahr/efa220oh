...
public class Mnemonics {
  ...
  /**
   * Clears the mnemonic cache for a window w. This method *must* be called whenever a window is
  ...
  /**
   * Sets the displayed text and mnemonic for a label. If s contains a mnemonic marked with "&",
   * this mnemonic is being preferred and may be grabbed from another component that already has
   * this mnemonic. Otherwise, this method determines a unique mnemonic for this label inside this
  ...
  /**
   * Sets the displayed text and mnemonic for a button. If s contains a mnemonic marked with "&",
   * this mnemonic is being preferred and may be grabbed from another component that already has
   * this mnemonic. Otherwise, this method determines a unique mnemonic for this button inside this
   * frame by itself, if any unique mnemonics are available.
   *
  ...
  /**
   * Sets the displayed text for a menu button. This method currently does *not* set mnemonics and
   * is intended for "inner" menu buttons (within a menu) that are not supposed to get global
   * mnemonics (global as related to their frame). This implementation currently does not support
   * mnemonics local to a specific menu.
   *
  ...
  /**
   * Checks whether the supplied string contains mnemonics (masked as "&") or ampassants (masked as
   * "&&").
   *
   * @param s the string
  ...
  /**
   * Strinps any mnemonics from the supplied string and transformes escaped ampassants ("&&") into
   * real ampassants ("&").
   *
   * @param s the string
