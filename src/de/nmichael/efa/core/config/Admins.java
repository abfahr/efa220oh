...
public class Admins extends StorageObject {
  ...
  public Admins(int storageType,
    ...
    super(storageType, storageLocation, storageUsername, storagePassword, "admins", DATATYPE,
  ...
  public Admins() {
    super(IDataAccess.TYPE_FILE_XML, Daten.efaCfgDirectory, null, null, "admins", DATATYPE,
        International.getString("Administratoren"));
    AdminRecord.initialize();
    dataAccess.setMetaData(MetaData.getMetaData(DATATYPE));
  }
  ...
  public void preModifyRecordCallback(DataRecord record, boolean add, boolean update, boolean delete)
    ...
    if (add || update) {
      ...
      if (ar.getPassword() == null || !ar.getPassword().isSet()) {
        throw new EfaModifyException(Logger.MSG_DATA_MODIFYEXCEPTION,
            International.getMessage("Das Feld '{field}' darf nicht leer sein.",
