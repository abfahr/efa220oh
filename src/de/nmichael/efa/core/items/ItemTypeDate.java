...
public class ItemTypeDate extends ItemTypeLabelTextfield {
  ...
  public void parseValue(String value) {
    try {
      if (value != null && value.trim().length() > 0) {
        ...
        TMJ tmj = EfaUtil.correctDate(value, referenceDate.getDay(), referenceDate.getMonth(),
  ...
  public int displayOnGui(Window dlg, JPanel panel, int x, int y) {
    ...
    if (showWeekday) {
      ...
      panel.add(weekdayLabel, new GridBagConstraints(x + labelGridWidth + fieldGridWidth, y,
          weekdayGridWidth, 1, 0.0, 0.0,
