...
public class DestinationRecord extends DataRecord implements IItemFactory {
  ...
  public static void initialize() {
    ...
    f.add(END);
    t.add(IDataAccess.DATA_STRING);
    f.add(STARTISBOATHOUSE);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(ROUNDTRIP);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(DESTINATIONAREAS);
    t.add(IDataAccess.DATA_STRING);
    f.add(PASSEDLOCKS);
  ...
  public Vector<IItemType> getGuiItems(AdminRecord admin) {
    ...
    if (Daten.efaConfig.getValueUseFunctionalityRowingBerlin()) {
      v.add(item = new ItemTypeString(DestinationRecord.GUIITEM_DESTINATIONAREAS,
          (getDestinationAreas() == null ? "" : getDestinationAreas().toString()),
    ...
    v.add(item = new ItemTypeInteger(DestinationRecord.PASSEDLOCKS, getPassedLocks(), 0,
  ...
  public static String makeDestinationPostfixedDestinationBoathouseString(String destination,
      String boathouse) {
