...
public class StatisticsRecord extends DataRecord implements IItemListener {
  ...
  public enum StatisticCategory {
    UNKNOWN, list, matrix, logbook, competition, other
  }

  public enum StatisticType {
    persons, boats, boatstatus, boatreservations, boatdamages, boatdamagestat, clubwork, anythingElse // if
                                                                                                      // this
                                                                                                      // is
                                                                                                      // selected,
                                                                                                      // it's
  ...
  public enum OutputTypes {
    UNKNOWN, internal, internaltxt, html, csv, xml, pdf, efawett
  }
  ...
  public static void initialize() {
    ...
    t.add(IDataAccess.DATA_LIST_STRING);
    f.add(FILTERBOATTYPEALL);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(FILTERBOATSEATS);
    t.add(IDataAccess.DATA_LIST_STRING);
    f.add(FILTERBOATSEATSALL);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(FILTERBOATRIGGING);
    t.add(IDataAccess.DATA_LIST_STRING);
    f.add(FILTERBOATRIGGINGALL);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(FILTERBOATCOXING);
    t.add(IDataAccess.DATA_LIST_STRING);
    f.add(FILTERBOATCOXINGALL);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(FILTERBOATOWNER);
    t.add(IDataAccess.DATA_LIST_STRING);
    f.add(FILTERBOATOWNERALL);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(FILTERBYPERSONID);
    t.add(IDataAccess.DATA_UUID);
    f.add(FILTERBYPERSONTEXT);
    t.add(IDataAccess.DATA_STRING);
    f.add(FILTERBYBOATID);
    t.add(IDataAccess.DATA_UUID);
    f.add(FILTERBYBOATTEXT);
    t.add(IDataAccess.DATA_STRING);
    f.add(FILTERBYGROUPID);
    t.add(IDataAccess.DATA_UUID);
    f.add(FILTERPROMPTPERSON);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(FILTERPROMPTBOAT);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(FILTERPROMPTGROUP);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(FILTERFROMTOBOATHOUSE);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(FILTERCOMMENTSINCLUDE);
    t.add(IDataAccess.DATA_STRING);
    f.add(FILTERCOMMENTSEXCLUDE);
    t.add(IDataAccess.DATA_STRING);
    f.add(FILTERMINSESSIONDISTANCE);
    t.add(IDataAccess.DATA_DISTANCE);
    f.add(FILTERONLYOPENDAMAGES);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(FILTERALSOOPENSESSIONS);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(FILTERONLYLOGBOOK);
    t.add(IDataAccess.DATA_STRING);
    f.add(SHOWFIELDS);
    t.add(IDataAccess.DATA_LIST_STRING);
    f.add(SHOWLOGBOOKFIELDS);
    t.add(IDataAccess.DATA_LIST_STRING);
    f.add(SHOWOTHERFIELDS);
    t.add(IDataAccess.DATA_LIST_STRING);
    f.add(AGGREGATIONS);
    t.add(IDataAccess.DATA_LIST_STRING);
    f.add(AGGRDISTANCEBARSIZE);
    t.add(IDataAccess.DATA_INTEGER);
    f.add(AGGRROWDISTANCEBARSIZE);
    t.add(IDataAccess.DATA_INTEGER);
    f.add(AGGRCOXDISTANCEBARSIZE);
    t.add(IDataAccess.DATA_INTEGER);
    f.add(AGGRSESSIONSBARSIZE);
    t.add(IDataAccess.DATA_INTEGER);
    f.add(AGGRAVGDISTBARSIZE);
    t.add(IDataAccess.DATA_INTEGER);
    f.add(AGGRDURATIONBARSIZE);
    t.add(IDataAccess.DATA_INTEGER);
    f.add(AGGRSPEEDBARSIZE);
    t.add(IDataAccess.DATA_INTEGER);
    f.add(COMPYEAR);
    t.add(IDataAccess.DATA_INTEGER);
    f.add(COMPPERCENTFULFILLED);
    t.add(IDataAccess.DATA_INTEGER);
    f.add(COMPOUTPUTSHORT);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(COMPOUTPUTRULES);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(COMPOUTPUTADDITIONALWITHREQUIREMENTS);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(COMPOUTPUTWITHOUTDETAILS);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(COMPOUTPUTALLDESTINATIONAREAS);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(SORTINGCRITERIA);
    t.add(IDataAccess.DATA_STRING);
    f.add(SORTINGORDER);
    t.add(IDataAccess.DATA_STRING);
    f.add(OUTPUTTYPE);
    ...
    f.add(OUTPUTFILE);
    t.add(IDataAccess.DATA_STRING);
    f.add(OUTPUTENCODING);
    t.add(IDataAccess.DATA_STRING);
    f.add(OUTPUTHTMLUPDATETABLE);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(OUTPUTCSVSEPARATOR);
    t.add(IDataAccess.DATA_STRING);
    f.add(OUTPUTCSVQUOTES);
    t.add(IDataAccess.DATA_STRING);
    f.add(OPTIONDISTANCEWITHUNIT);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(OPTIONTRUNCATEDIST);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(OPTIONLISTALLNULLENTRIES);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(OPTIONIGNORENULLVALUES);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(OPTIONSUMGUESTSANDOTHERS);
    t.add(IDataAccess.DATA_BOOLEAN);
    f.add(OPTIONSUMGUESTSBYCLUB);
    t.add(IDataAccess.DATA_BOOLEAN);
  ...
  public void setDefaults() {
    ...
    setAggregations(new DataTypeList<String>(new String[] { AGGR_DISTANCE, AGGR_SESSIONS,
        AGGR_AVGDISTANCE,
        AGGR_DAMAGECOUNT, AGGR_DAMAGEDURATION, AGGR_CLUBWORK, AGGR_CLUBWORKTARGET,
        AGGR_CBRELTOTARGET }));
    ...
    if (category == StatisticCategory.competition) {
      if (valuesOrDisplay == ARRAY_STRINGLIST_VALUES) {
        return (Daten.wettDefs != null
            ? Daten.wettDefs.getAllWettDefKeys()
            : new String[0]);
      } else {
        return (Daten.wettDefs != null
            ? Daten.wettDefs.getAllWettDefNames()
            : new String[0]);
  ...
  public String getStatisticTypeDescription() {
    ...
    for (int i = 0; allTypes != null && type != null && i < allTypes.length; i++) {
      if (type.equals(allTypes[i])) {
        String[] allDisplay = getStatisticTypes(getStatisticCategoryEnum(),
  ...
  public String[] getFilterStatusListDisplay() {
    return getPersistence().getProject().getStatus(false)
        .makeStatusArray(Status.ARRAY_STRINGLIST_DISPLAY);
  }

  public boolean isFilterStatusAllSelected() {
    DataTypeList list = getFilterStatus();
    return getFilterStatusAll()
        || (list != null && list.length() == getFilterStatusListValues().length);
  }
  ...
  public boolean isFilterBoatTypeAllSelected() {
    ...
    return getFilterBoatTypeAll()
        || (list != null && list.length() == EfaTypes
            .makeBoatTypeArray(EfaTypes.ARRAY_STRINGLIST_VALUES).length);
  }
  ...
  public boolean isFilterBoatSeatsAllSelected() {
    ...
    return getFilterBoatSeatsAll()
        || (list != null && list.length() == EfaTypes
            .makeBoatSeatsArray(EfaTypes.ARRAY_STRINGLIST_VALUES).length);
  }
  ...
  public boolean isFilterBoatRiggingAllSelected() {
    ...
    return getFilterBoatRiggingAll()
        || (list != null && list.length() == EfaTypes
            .makeBoatRiggingArray(EfaTypes.ARRAY_STRINGLIST_VALUES).length);
  }
  ...
  public boolean isFilterBoatCoxingAllSelected() {
    ...
    return getFilterBoatCoxingAll()
        || (list != null && list.length() == EfaTypes
            .makeBoatCoxingArray(EfaTypes.ARRAY_STRINGLIST_VALUES).length);
  }
  ...
  public boolean isFilterBoatOwnerAllSelected() {
    ...
    return getFilterBoatOwnerAll()
        || (list != null
            && list.length() == getFilterBoatOwnerArray(EfaTypes.ARRAY_STRINGLIST_VALUES).length);
  }
  ...
  public String getFilterByPersonIdAsString(long validAt) {
    try {
      return getPersistence().getProject().getPersons(false).getPerson(sFilterByPersonId, validAt)
          .getQualifiedName();
    } catch (Exception e) {
      return null;
    }
  ...
  public String getFilterByBoatIdAsString(long validAt) {
    try {
      return getPersistence().getProject().getBoats(false).getBoat(sFilterByBoatId, validAt)
          .getQualifiedName();
    } catch (Exception e) {
      return null;
    }
  ...
  public String getFilterByGroupIdAsString(long validAt) {
    try {
      return getPersistence().getProject().getGroups(false)
          .findGroupRecord(sFilterByGroupId, validAt).getQualifiedName();
    } catch (Exception e) {
      return null;
    }
  }
  ...
  public String[] getAggregationList(StatisticType type, int valuesOrDisplay) {
    ...
    allKeys.put(AGGR_AVGDISTANCE, DataTypeDistance.getDefaultUnitAbbrevation(true) + "/"
        + International.getString("Fahrt"));
    ...
    allKeys.put(AGGR_CLUBWORKTARGET,
        International.getString("Vereinsarbeit") + "-" + International.getString("Soll"));
  ...
  public Vector<IItemType> getGuiItems(AdminRecord admin) {
    ...
    v.add(item = new ItemTypeBoolean(StatisticsRecord.PUBLICLYAVAILABLE, getPubliclyAvailable(),
        IItemType.TYPE_PUBLIC, CAT_BASEDATA, International
            .getString("Statistik allgemein verfügbar")));
    ...
    v.add(item = new ItemTypeStringList(StatisticsRecord.STATISTICCATEGORY, getStatisticCategory(),
        getStatisticCategories(ARRAY_STRINGLIST_VALUES),
        getStatisticCategories(ARRAY_STRINGLIST_DISPLAY),
    ...
    v.add(item = new ItemTypeMultiSelectList<String>(StatisticsRecord.FILTERBOATTYPE,
        getFilterBoatType(),
        EfaTypes.makeBoatTypeArray(EfaTypes.ARRAY_STRINGLIST_VALUES), EfaTypes
            .makeBoatTypeArray(EfaTypes.ARRAY_STRINGLIST_DISPLAY),
    ...
    v.add(item = new ItemTypeBoolean(StatisticsRecord.FILTERBOATTYPEALL, getFilterBoatTypeAll(),
        ...
        International.getString("alle")));
    item.registerItemListener(this);
    v.add(item = new ItemTypeMultiSelectList<String>(StatisticsRecord.FILTERBOATSEATS,
        getFilterBoatSeats(),
        EfaTypes.makeBoatSeatsArray(EfaTypes.ARRAY_STRINGLIST_VALUES), EfaTypes
    ...
    v.add(item = new ItemTypeBoolean(StatisticsRecord.FILTERBOATSEATSALL, getFilterBoatSeatsAll(),
        ...
        International.getString("alle")));
    item.registerItemListener(this);
    v.add(item = new ItemTypeMultiSelectList<String>(StatisticsRecord.FILTERBOATRIGGING,
        getFilterBoatRigging(),
        EfaTypes.makeBoatRiggingArray(EfaTypes.ARRAY_STRINGLIST_VALUES), EfaTypes
            .makeBoatRiggingArray(EfaTypes.ARRAY_STRINGLIST_DISPLAY),
    ...
    v.add(item = new ItemTypeBoolean(StatisticsRecord.FILTERBOATRIGGINGALL,
        getFilterBoatRiggingAll(),
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FILTER, CAT_FILTERBOATRIGG),
        International.getString("alle")));
    item.registerItemListener(this);
    v.add(item = new ItemTypeMultiSelectList<String>(StatisticsRecord.FILTERBOATCOXING,
        getFilterBoatCoxing(),
        EfaTypes.makeBoatCoxingArray(EfaTypes.ARRAY_STRINGLIST_VALUES), EfaTypes
            .makeBoatCoxingArray(EfaTypes.ARRAY_STRINGLIST_DISPLAY),
    ...
    v.add(item = new ItemTypeBoolean(StatisticsRecord.FILTERBOATCOXINGALL,
        getFilterBoatCoxingAll(),
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FILTER, CAT_FILTERBOATCOXING),
        International.getString("alle")));
    item.registerItemListener(this);
    v.add(item = new ItemTypeMultiSelectList<String>(StatisticsRecord.FILTERBOATOWNER,
        getFilterBoatOwner(),
        getFilterBoatOwnerArray(EfaTypes.ARRAY_STRINGLIST_VALUES),
        getFilterBoatOwnerArray(EfaTypes.ARRAY_STRINGLIST_DISPLAY),
    ...
    ((ItemTypeStringAutoComplete) item)
        .setAlternateFieldNameForPlainText(StatisticsRecord.FILTERBYPERSONTEXT);
    v.add(item = getGuiItemTypeStringAutoComplete(StatisticsRecord.FILTERBYBOATID, null,
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FILTER, CAT_FILTERINDIVIDUAL),
        getPersistence().getProject().getBoats(false), System.currentTimeMillis(),
        System.currentTimeMillis(),
    ...
    ((ItemTypeStringAutoComplete) item)
        .setAlternateFieldNameForPlainText(StatisticsRecord.FILTERBYBOATTEXT);
    v.add(item = getGuiItemTypeStringAutoComplete(StatisticsRecord.FILTERBYGROUPID,
        getFilterByGroupId(),
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FILTER, CAT_FILTERINDIVIDUAL),
        getPersistence().getProject().getGroups(false), System.currentTimeMillis(),
        System.currentTimeMillis(),
    ...
    v.add(item = new ItemTypeBoolean(StatisticsRecord.FILTERFROMTOBOATHOUSE,
        getFilterFromToBoathouse(),
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FILTER, CAT_FILTERVARIOUS),
        International.getString("Start und Ziel ist Bootshaus")));
    v.add(item = new ItemTypeString(StatisticsRecord.FILTERCOMMENTSINCLUDE,
        getFilterCommentsInclude(),
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FILTER, CAT_FILTERVARIOUS),
        International.getString("Bemerkungsfeld enthält")));
    v.add(item = new ItemTypeString(StatisticsRecord.FILTERCOMMENTSEXCLUDE,
        getFilterCommentsExclude(),
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FILTER, CAT_FILTERVARIOUS),
        International.getString("Bemerkungsfeld enthält nicht")));
    v.add(item = new ItemTypeDistance(StatisticsRecord.FILTERMINSESSIONDISTANCE,
        getFilterMinDessionDistance(),
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FILTER, CAT_FILTERVARIOUS),
        International.getString("Mindestentfernung")));
    v.add(item = new ItemTypeBoolean(StatisticsRecord.FILTERALSOOPENSESSIONS,
        getFilterAlsoOpenSessions(),
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FILTER, CAT_FILTERVARIOUS),
        International.getString("auch offene Fahrten berücksichtigen")));
    v.add(item = new ItemTypeBoolean(StatisticsRecord.FILTERONLYOPENDAMAGES,
        getFilterOnlyOpenDamages(),
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FILTER, CAT_FILTERVARIOUS),
        International.getString("nur offene Bootsschäden")));
    ...
    // CAT_FIELDS
    v.add(item = new ItemTypeMultiSelectList<String>(StatisticsRecord.AGGREGATIONS,
        getAggregations(),
    ...
    ((ItemTypeMultiSelectList) item).setFieldSize(400, 300);
    v.add(item = new ItemTypeMultiSelectList<String>(StatisticsRecord.SHOWLOGBOOKFIELDS,
        getShowLogbookFields(),
        getLogbookFieldsList(ARRAY_STRINGLIST_VALUES),
        getLogbookFieldsList(ARRAY_STRINGLIST_DISPLAY),
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FIELDS, CAT_FIELDSLOGBOOK),
        International.getString("Ausgabe")));
    ((ItemTypeMultiSelectList) item).setFieldSize(400, 300);
    v.add(item = new ItemTypeMultiSelectList<String>(StatisticsRecord.SHOWOTHERFIELDS,
        getShowOtherFields(),
    ...
    v.add(item = new ItemTypeInteger(StatisticsRecord.AGGRDISTANCEBARSIZE,
        getAggrDistanceBarSize(), 0, 1000,
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FIELDS, CAT_FIELDSBARS),
        International.getString("Kilometer")));
    v.add(item = new ItemTypeInteger(StatisticsRecord.AGGRROWDISTANCEBARSIZE,
        getAggrRowDistanceBarSize(), 0, 1000,
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FIELDS, CAT_FIELDSBARS),
        getRowingKmString()));
    v.add(item = new ItemTypeInteger(StatisticsRecord.AGGRCOXDISTANCEBARSIZE,
        getAggrCoxDistanceBarSize(), 0, 1000,
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FIELDS, CAT_FIELDSBARS),
        getCoxingKmString()));
    v.add(item = new ItemTypeInteger(StatisticsRecord.AGGRSESSIONSBARSIZE,
        getAggrSessionsBarSize(), 0, 1000,
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FIELDS, CAT_FIELDSBARS),
        International.getString("Fahrten")));
    v.add(item = new ItemTypeInteger(StatisticsRecord.AGGRAVGDISTBARSIZE,
        getAggrAvgDistanceBarSize(), 0, 1000,
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FIELDS, CAT_FIELDSBARS),
        International.getString("Km/Fahrt")));
    v.add(item = new ItemTypeInteger(StatisticsRecord.AGGRDURATIONBARSIZE,
        getAggrDurationBarSize(), 0, 1000,
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FIELDS, CAT_FIELDSBARS),
        International.getString("Dauer")));
    v.add(item = new ItemTypeInteger(StatisticsRecord.AGGRSPEEDBARSIZE, getAggrSpeedBarSize(), 0,
        1000,
        IItemType.TYPE_PUBLIC, BaseTabbedDialog.makeCategory(CAT_FIELDS, CAT_FIELDSBARS),
        International.getString("Geschwindigkeit")));
    ...
    v.add(item = new ItemTypeInteger(StatisticsRecord.COMPPERCENTFULFILLED,
        getCompPercentFulfilled(),
        0, 100,
        IItemType.TYPE_PUBLIC, CAT_COMP,
    ...
    v.add(item = new ItemTypeBoolean(StatisticsRecord.COMPOUTPUTWITHOUTDETAILS,
        getCompOutputWithoutDetails(),
        IItemType.TYPE_PUBLIC, CAT_COMP,
        International.getString("Ausgabe ohne Details")));
    v.add(item = new ItemTypeBoolean(StatisticsRecord.COMPOUTPUTADDITIONALWITHREQUIREMENTS,
        getCompOutputAdditionalWithRequirements(),
        IItemType.TYPE_PUBLIC, CAT_COMP,
        International.getString("Ausgabe zusätzlich mit Anforderungen")));
    v.add(item = new ItemTypeBoolean(StatisticsRecord.COMPOUTPUTALLDESTINATIONAREAS,
        getCompOutputAllDestinationAreas(),
        IItemType.TYPE_PUBLIC, CAT_COMP,
    ...
    v.add(item = new ItemTypeBoolean(StatisticsRecord.OUTPUTHTMLUPDATETABLE,
        getOutputHtmlUpdateTable(),
        IItemType.TYPE_PUBLIC, CAT_OUTPUT,
    ...
    // CAT_OPTIONS
    v.add(item = new ItemTypeBoolean(StatisticsRecord.OPTIONDISTANCEWITHUNIT,
        getOptionDistanceWithUnit(),
        IItemType.TYPE_PUBLIC, CAT_OPTIONS,
        International.getString("Entfernungen mit Längeneinheit ausgeben")));
    v.add(item = new ItemTypeBoolean(StatisticsRecord.OPTIONTRUNCATEDIST,
        getOptionTruncateDistance(),
        IItemType.TYPE_PUBLIC, CAT_OPTIONS,
        International.getString("Nachkommastellen bei Ausgabe von Entfernungen abschneiden")));
    v.add(item = new ItemTypeBoolean(StatisticsRecord.OPTIONLISTALLNULLENTRIES,
        getOptionListAllNullEntries(),
        IItemType.TYPE_PUBLIC, CAT_OPTIONS,
        International.getString("Alle Einträge ausgeben")));
    v.add(item = new ItemTypeBoolean(StatisticsRecord.OPTIONIGNORENULLVALUES,
        getOptionIgnoreNullValues(),
        IItemType.TYPE_PUBLIC, CAT_OPTIONS,
        International.getString("Nullwerte nicht ausgeben")));
    v.add(item = new ItemTypeBoolean(StatisticsRecord.OPTIONSUMGUESTSANDOTHERS,
        getOptionSumGuestsAndOthers(),
        IItemType.TYPE_PUBLIC, CAT_OPTIONS,
        International.getString("Gäste und andere zusammenfassen")));
    v.add(item = new ItemTypeBoolean(StatisticsRecord.OPTIONSUMGUESTSBYCLUB,
        getOptionSumGuestsByClub(),
        IItemType.TYPE_PUBLIC, CAT_OPTIONS,
  ...
  public boolean prepareStatisticSettings(AdminRecord admin) {
    ...
    try {
      sFilterStatusOther = sFilterStatus.containsKey(getPersistence().getProject().getStatus(false)
          .getStatusOther().getId());
    } catch (Exception eignore) {
        ...
        if (o instanceof UUID) {
          ...
          if (sPublicStatistic) {
            PersonRecord p = getPersistence().getProject().getPersons(false)
                .getPerson(sFilterByPersonId, sValidAt);
    ...
    DataTypeList<String> fields = (sStatisticCategory != StatisticCategory.other ? getShowFields()
        : getShowOtherFields());
    ...
    for (int i = 0; aggr != null && i < aggr.length(); i++) {
      ...
      if (s.equals(AGGR_DISTANCE) && sStatisticCategory != StatisticCategory.other) {
      ...
      } else if (s.equals(AGGR_DAMAGEDURATION)
          && sStatisticTypeEnum == StatisticType.boatdamagestat) {
        sIsAggrDamageDuration = true;
      } else if (s.equals(AGGR_DAMAGEAVGDUR)
          && sStatisticTypeEnum == StatisticType.boatdamagestat) {
        ...
        sIsAggrClubworkRelativeToTarget = true;
          ...
          && sStatisticTypeEnum == StatisticType.clubwork) {
    ...
    if (Email.getEmailAddressFromMailtoString(sOutputFile.toLowerCase()) != null) {
      ...
      sOutputFile = Daten.efaTmpDirectory + "output_" + System.currentTimeMillis()
          + getOutputExtension();
    }
  ...
  private Object promptForInput(UUID id, String text, StorageObject so, String description) {
    ItemTypeStringAutoComplete item = getGuiItemTypeStringAutoComplete("FIELD", null,
  ...
  public void prepareTableColumns(Hashtable<Object, StatisticsData> data) {
    ...
    if (sStatisticCategory == StatisticCategory.list ||
      ...
      if (sIsFieldsPosition) {
        ...
        // The following line is useless, but added with intention to keep the translation for
        // "Platz"
      ...
      if (sIsAggrAvgDistance) {
        pTableColumns.add(DataTypeDistance.getDefaultUnitAbbrevation() + "/"
            + International.getString("Fahrt"));
      }
      if (sIsAggrDuration) {
        ...
        if (matrixkeys != null) {
          for (Object mk : matrixkeys) {
            ...
            if (mk instanceof UUID) {
              PersonRecord pr = persons.getPerson((UUID) mk, sTimestampBegin, sTimestampEnd,
                  sValidAt);
              if (pr != null) {
                pMatrixColumns.put(pr.getQualifiedName(), mk);
              } else {
                pMatrixColumns.put("*** " + International.getString("ungültiger Eintrag") + " ***",
                    mk);
              }
  ...
  private void setDefaultSorting(StatisticCategory cat) {
    ...
    if (cat == StatisticCategory.logbook) {
      ...
      if (SORTING_ENTRYNO.equals(crit) || SORTING_DATE.equals(crit)) {
        itemTypeSortingCriteria.parseAndShowValue(StatisticsRecord.SORTING_DISTANCE);
    ...
    if (cat == StatisticCategory.competition) {
      ...
      if (comp != null && year > 0) {
        ...
        if (wett != null && wett.von != null) {
          itemDateFrom.parseAndShowValue(wett.von.tag + "." + wett.von.monat + "."
              + (wett.von.jahr + year));
        }
        if (wett != null && wett.bis != null) {
          itemDateTo.parseAndShowValue(wett.bis.tag + "." + wett.bis.monat + "."
              + (wett.bis.jahr + year));
        }
      }
  ...
  private void selectedStatisticsCategory(IItemType itemType) {
    ...
    if (itemAggrFields != null) {
      ...
      DataTypeList<String> selected = new DataTypeList<String>(getAggregationList(typeEnum,
          ARRAY_STRINGLIST_VALUES));
    ...
    if (itemShowOtherFields != null) {
      ...
      DataTypeList<String> selected = new DataTypeList<String>(getOtherFieldsListDefaults(typeEnum,
          ARRAY_STRINGLIST_VALUES));
  ...
  public void itemListenerAction(IItemType itemType, AWTEvent event) {
    ...
    if (itemType.getName().equals(FILTERBOATSEATSALL) && event instanceof ActionEvent) {
      if (itemFilterBoatSeats != null && itemType.getValueFromField() != null) {
        itemFilterBoatSeats
            .setEnabled(itemType.getValueFromField().equals(Boolean.toString(false)));
      }
    }
    if (itemType.getName().equals(FILTERBOATRIGGINGALL) && event instanceof ActionEvent) {
      if (itemFilterBoatRigging != null && itemType.getValueFromField() != null) {
        itemFilterBoatRigging.setEnabled(itemType.getValueFromField().equals(
    ...
    if (itemType.getName().equals(FILTERBOATCOXINGALL) && event instanceof ActionEvent) {
      if (itemFilterBoatCoxing != null && itemType.getValueFromField() != null) {
        itemFilterBoatCoxing.setEnabled(itemType.getValueFromField()
      ...
      if (itemOutputFile != null) {
        ...
        if (pos > 0) {
          fname = fname.substring(0, pos) + "."
              + this.getOutputTypeFileExtensionForEnum(newOutputType);
    ...
    if (itemType.getName().equals(PUBLICLYAVAILABLE) && event instanceof ActionEvent) {
      ((ItemTypeBoolean) itemType).setColor(
          (itemType.getValueFromField().equals(Boolean.toString(true)) ? Color.blue : Color.black));
    }
