...
public class DataKey<T1, T2, T3> implements Comparable {
  ...
  @Override
  public int hashCode() {
    return (v1 != null && v2 == null ? v1.hashCode() :
  ...
  public String encodeAsString() {
    ...
    if (v1 != null) {
      s.append("<" + ENCODING_KEY_PART1 + ">" + EfaUtil.escapeXml(v1.toString()) + "</"
          + ENCODING_KEY_PART1 + ">");
    }
    if (v2 != null) {
      s.append("<" + ENCODING_KEY_PART2 + ">" + EfaUtil.escapeXml(v2.toString()) + "</"
          + ENCODING_KEY_PART2 + ">");
    }
    if (v3 != null) {
      s.append("<" + ENCODING_KEY_PART3 + ">" + EfaUtil.escapeXml(v3.toString()) + "</"
          + ENCODING_KEY_PART3 + ">");
    }
    s.append("</" + ENCODING_KEY + ">");
    return s.toString();
