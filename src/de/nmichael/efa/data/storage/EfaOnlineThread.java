...
public class EfaOnlineThread extends Thread {
  ...
  private void updateStatus(String baseurl, String username, String password, int port) {
    try {
      ...
      Logger.log(Logger.WARNING, Logger.MSG_EONL_WARNING,
          "efaOnline status update failed: " + e.getMessage());
      Logger.logdebug(e);
    }
  }
    ...
    while (true) {
      try {
        if (Daten.efaConfig != null ? Daten.efaConfig.getValueDataRemoteEfaOnlineEnabled() : false) {
          String username = (Daten.efaConfig != null ? Daten.efaConfig
              .getValueDataRemoteEfaOnlineUsername() : null);
          String password = (Daten.efaConfig != null ? Daten.efaConfig
              .getValueDataRemoteEfaOnlinePassword() : null);
          String url = (Daten.efaConfig != null ? Daten.efaConfig.getValueDataRemoteEfaOnlineUrl()
              : null);
          int remoteEfaPort = (Daten.efaConfig != null ? Daten.efaConfig
              .getValueDataataRemoteEfaServerPort() : -1);
        ...
        try {
          long sec = (Daten.efaConfig != null ? Daten.efaConfig
              .getValueDataRemoteEfaOnlineUpdateInterval() : 3600);
