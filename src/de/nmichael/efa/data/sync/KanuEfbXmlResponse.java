...
public class KanuEfbXmlResponse extends XmlHandler {
  ...
  private Vector<Hashtable<String, String>> data = new Vector<Hashtable<String, String>>(); // Vector
  // of
  ...
  public void endElement(String uri, String localName, String qname) {
    ...
    if (inRecord && recordName != null &&
        (localName.equals(recordName) ||
            localName.equals(ROOT_ELEMENT))) { // make sure to also add record for login response, which
      // doesn't really have a "recordName"
      data.add(fields);
      fields = null;
      inRecord = false;
      recordName = null;
  ...
  public void printAll() {
    ...
    for (int i = 0; data != null && i < data.size(); i++) {
      ...
      for (int j = 0; fieldNames != null && j < fieldNames.length; j++) {
        ...
        Logger.log(Logger.DEBUG, Logger.MSG_SYNC_SYNCINFO, "    " + EfaUtil.int2String(i, 4) + ":"
            + fieldNames[j] + "=" + value);
      }
    }
