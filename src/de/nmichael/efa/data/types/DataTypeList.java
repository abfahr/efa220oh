...
public class DataTypeList<T> {
  ...
  public static DataTypeList parseList(String s, int dataType) {
    ...
    switch (dataType) {
      ...
      case IDataAccess.DATA_LIST_STRING: // we accept both the value's data type as well as the
        // list's data type
        list = new ArrayList<String>();
        break;
      case IDataAccess.DATA_INTEGER:
      case IDataAccess.DATA_LIST_INTEGER: // we accept both the value's data type as well as the
        // list's data type
      ...
      case IDataAccess.DATA_LIST_UUID: // we accept both the value's data type as well as the list's
        // data type
