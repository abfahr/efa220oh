...
public class DRVSignaturFrame extends JDialog implements ActionListener {
  ...
  public DRVSignaturFrame(JDialog parent, DRVSignatur drvSignatur) {
    ...
    EfaUtil.pack(this);
    this.parent = parent;
    DRVSignaturFrame.drvSignatur = drvSignatur;
  ...
  private void jbInit() throws Exception {
    ...
    try {
      ...
      fahrtenheftPanel.add(jLabel16, new GridBagConstraints(0, 12, 1, 1, 0.0, 0.0
          , GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
      fahrtenheftPanel
      .add(efLetztKm, new GridBagConstraints(1, 12, 1, 1, 0.0, 0.0
  ...
  void frIni(boolean initial) {
    if (drvSignatur == null) {
      ...
      if (initial) {
        editMeldungButton_actionPerformed(null);
      }
    } else {
      ...
      if (drvSignatur.getVersion() < 3) {
        this.efLetztKm.setText("- Erst ab FA-Version 3 -");
      } else {
        this.efLetztKm.setText(Integer.toString(drvSignatur.getLetzteKm()));
      }
      ...
      if (initial) {
        this.editMeldungButton.requestFocus();
      }
    }
    if (initial) {
      EfaUtil.pack(this);
  ...
  void setSignatureValid(DRVSignatur drvSignatur) {
    ...
    switch (state) {
      ...
      case DRVSignatur.SIG_UNKNOWN_KEY:
        this.signatureValidLabel
        .setText("Das Fahrtenheft kann nicht geprüft werden: Unbekannter Schlüssel!");
        this.signatureValidLabel.setForeground(Color.red);
        break;
      case DRVSignatur.SIG_UNKNOWN_VERSION:
        this.signatureValidLabel
        .setText("Das Fahrtenheft kann nicht geprüft werden: Unbekannte Version!");
        this.signatureValidLabel.setForeground(Color.red);
        break;
      ...
      case DRVSignatur.SIG_KEY_NOT_VALID_FOR_YEAR:
        this.signatureValidLabel.setText("Das Fahrtenheft ist ungültig: Schlüssel ist für "
            + drvSignatur.getJahr() + " nicht gültig!");
        this.signatureValidLabel.setForeground(Color.red);
        break;
      case DRVSignatur.SIG_KEY_NOT_VALID_ON_SIGDATE:
        this.signatureValidLabel
        .setText("Das Fahrtenheft ist ungültig: Schlüssel war zum Erstellungszeitpunkt ungültig!");
        this.signatureValidLabel.setForeground(Color.red);
        break;
      case DRVSignatur.SIG_ERROR:
        this.signatureValidLabel.setText("Beim Überprüfen des Fahrtenhefts trat ein Fehler auf: "
            + drvSignatur.getSignatureError());
        this.signatureValidLabel.setForeground(Color.red);
        break;
    }
        ...
        "Um die Signatur zu prüfen, benötigt efa den öffentlichen Schlüssel '" + keyname + "'.\n" +
            ...
            "Schlüssel aus Internet herunterladen", "Schlüssel aus Datei einlesen")) {
              case 0:
                ...
                if (!DownloadThread.getFile(parent, remoteFile, localFile, true)
  ...
  void editMeldungButton_actionPerformed(ActionEvent e) {
    this.hinweisLabel
    .setText("Bitte gib das vom DRV signierte elektronische Fahrtenheft vollständig ein, z.B.");
    this.hinweisLabelBsp
    .setText("12345678;Manfred;Mustermann;23.05.1966;12;54321;2004;AQEwL AIUfy ...");
    this.hinweisLabelAchtung
    .setText("Achtung: Es muß unbedingt jedes Zeichen exakt wie angegeben eingegeben werden!");
  ...
  void setFahrtenheft(String s) {
    ...
    this.fahrtenheft.setText((DRVSignaturFrame.drvSignatur != null ? DRVSignaturFrame.drvSignatur
        .toString() : ""));
    frIni(false);
  ...
  void printButton_actionPerformed(ActionEvent e) {
    ...
    try {
      ...
      f.write("<body>\n");
      f.write("<h1 align=\"center\">elektronisches Fahrtenheft<br>für " + drvSignatur.getVorname()
          + " " + drvSignatur.getNachname() + "</h1>\n");
      f.write("<table align=\"center\" border=\"3\" width=\"100%\">\n");
      f.write("<tr><td>DRV-Teilnehmernummer:</td><td><tt><b>" + drvSignatur.getTeilnNr()
          + "</b></tt></td></tr>\n");
      f.write("<tr><td>Vorname:</td><td><tt><b>" + drvSignatur.getVorname()
          + "</b></tt></td></tr>\n");
      f.write("<tr><td>Nachname:</td><td><tt><b>" + drvSignatur.getNachname()
          + "</b></tt></td></tr>\n");
      f.write("<tr><td>Jahrgang:</td><td><tt><b>" + drvSignatur.getJahrgang()
          + "</b></tt></td></tr>\n");
      f.write("<tr><td>Anzahl der Fahrtenabzeichen:</td><td><tt><b>"
          + drvSignatur.getAnzAbzeichen() + "</b></tt></td></tr>\n");
      f.write("<tr><td>Insgesamt nachgewiesene Kilometer:</td><td><tt><b>" + drvSignatur.getGesKm()
          + "</b></tt></td></tr>\n");
      f.write("<tr><td>... davon Fahrtenabzeichen Jugend A/B:</td><td><tt><b>"
          + drvSignatur.getAnzAbzeichenAB() + "</b></tt></td></tr>\n");
      f.write("<tr><td>... davon Kilometer Jugend A/B:</td><td><tt><b>" + drvSignatur.getGesKmAB()
          + "</b></tt></td></tr>\n");
      f.write("<tr><td>Jahr der letzten elektronischen Meldung:</td><td><tt><b>"
          + drvSignatur.getJahr() + "</b></tt></td></tr>\n");
      if (drvSignatur.getVersion() >= 3) {
        f.write("<tr><td>Kilometer bei letzter elektronischer Meldung:</td><td><tt><b>"
            + drvSignatur.getLetzteKm() + "</b></tt></td></tr>\n");
      }
      f.write("<tr><td>Ausstellungsdatum des Fahrtenhefts:</td><td><tt><b>"
          + drvSignatur.getSignaturDatum(true) + "</b></tt></td></tr>\n");
      f.write("<tr><td>Fahrtenabzeichen-Version:</td><td><tt><b>" + drvSignatur.getVersion()
          + "</b></tt></td></tr>\n");
      f.write("<tr><td>öffentlicher DRV-Schlüssel:</td><td><tt><b>" + drvSignatur.getKeyName()
          + "</b></tt></td></tr>\n");
      f.write("<tr><td>DRV-Signatur:</td><td><tt><b>" + drvSignatur.getSignaturString()
          + "</b></tt></td></tr>\n");
      f.write("<tr><td>elektronisches Fahrtenheft (zur Eingabe):</td><td><tt><b>"
          + drvSignatur.toString() + "</b></tt></td></tr>\n");
      if (signatureValidLabel.getForeground() == Color.red) {
        f.write("<tr><td colspan=\"2\"><font color=\"red\"><b>" + signatureValidLabel.getText()
            + "</b></font></td></tr>\n");
      }
      f.write("</table>\n");
      f.write("</body></html>\n");
