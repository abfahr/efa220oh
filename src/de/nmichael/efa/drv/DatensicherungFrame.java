...
/**
 * Title: efa - Elektronisches Fahrtenbuch Description: Copyright: Copyright (c) 2001 Company:
 *
...
public class DatensicherungFrame extends JDialog implements ActionListener {
  ...
  private void createTable() {
    ...
    directoryTable.getColumn("Unterverzeichnisse").setCellEditor(
  ...
  void dirSelectButton_actionPerformed(ActionEvent e) {
    ...
    if (dir.length() == 0 || !new File(dir).isDirectory()) {
      dir = Daten.efaMainDirectory;
    }
    dir = Dialog.dateiDialog(this, "Backup-Verzeichnis ausw�hlen", null, null, dir, null,
        "ausw�hlen", false, true);
    if (dir != null) {
      backupVerzeichnis.setText(dir);
    }
  }
  ...
  void startButton_actionPerformed(ActionEvent e) {
    ...
    String zipdir = (efaBackupRadioButton.isSelected() ? Daten.efaBakDirectory : backupVerzeichnis
        .getText().trim());
