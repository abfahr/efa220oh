...
public class VereinsConfig extends DatenListe {
  ...
  public void askForZielbereichOnStart() {
    if (zielbereich.length() > 0) {
      return;
    }
    zielbereich = Dialog.inputDialog("eigener Zielbereich",
        "Nur für Berliner Vereine (andere Vereine bitte leer lassen!):\n\n" +
    ...
    if (i < 1 || i > 10) {
      ...
      zielbereich = Integer.toString(i);
    }
    writeFile();
