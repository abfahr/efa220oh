...
public class AdminPasswordChangeDialog extends BaseDialog {
  ...
  public AdminPasswordChangeDialog(Frame parent, AdminRecord adminRecord) {
    super(parent, International.getStringWithMnemonic("Paßwort ändern"), International
        .getStringWithMnemonic("Paßwort ändern"));
  ...
  protected void iniDialog() throws Exception {
    ...
    name = new ItemTypeString("NAME", adminRecord.getName(), IItemType.TYPE_PUBLIC, "",
    ...
    if (mustEnterOldPass) {
      passwordOld = new ItemTypePassword("PASSWORD_OLD", "", IItemType.TYPE_PUBLIC, "",
          International.getStringWithMnemonic("Altes Paßwort"));
      passwordOld.setFieldSize(120, 20);
      passwordOld.setNotNull(true);
      passwordOld.displayOnGui(this, mainPanel, 0, 1);
    }

    passwordNew1 = new ItemTypePassword("PASSWORD_NEW1", "", IItemType.TYPE_PUBLIC, "",
        International.getStringWithMnemonic("Neues Paßwort"));
    ...
    passwordNew2 = new ItemTypePassword("PASSWORD_NEW2", "", IItemType.TYPE_PUBLIC, "",
        International.getStringWithMnemonic("Neues Paßwort") +
  ...
  public void closeButton_actionPerformed(ActionEvent e) {
    ...
    if (passwordOld != null
        && (myAdmins.login(adminRecord.getName(), passwordOld.getValue())) == null) {
