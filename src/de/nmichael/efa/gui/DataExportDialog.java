...
public class DataExportDialog extends BaseDialog {
  ...
  protected void iniDialog() throws Exception {
    ...
    exportSelectPanel.add(exportSelectLabel, new GridBagConstraints(0, 0, 3, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE,
        new Insets(10, 0, 0, 0), 0, 0));
    exportSelectPanel.add(exportSelectAll, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE,
        new Insets(0, 0, 10, 10), 0, 0));
    exportSelectPanel.add(exportSelectSelected, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE,
        new Insets(0, 0, 10, 10), 0, 0));
    exportSelectPanel.add(exportSelectFiltered, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE,
        new Insets(0, 0, 10, 10), 0, 0));
    mainControlPanel.add(exportSelectPanel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE,
        new Insets(10, 0, 0, 0), 0, 0));

    JLabel fieldsLabel = new JLabel();
    Mnemonics.setLabel(this, fieldsLabel, International.getString("ausgewählte Felder") + ":");
    mainControlPanel.add(fieldsLabel, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE,
        new Insets(10, 0, 0, 0), 0, 0));
    ...
    filePanel.add(fileTypeLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE,
        new Insets(10, 0, 0, 0), 0, 0));
    filePanel.add(fileTypeXml, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE,
        new Insets(10, 0, 0, 0), 0, 0));
  ...
  public void closeButton_actionPerformed(ActionEvent e) {
    ...
    DataExport.Format format = (fileTypeXml.isSelected() ? DataExport.Format.xml
