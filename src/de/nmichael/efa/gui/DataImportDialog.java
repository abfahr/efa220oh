...
public class DataImportDialog extends BaseDialog implements IItemListener {
  ...
  protected void iniDialog() throws Exception {
    ...
    mainPanel.add(fileTypeXml, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE,
        new Insets(0, 0, 0, 0), 0, 0));
    mainPanel.add(fileTypeCsv, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE,
        new Insets(0, 0, 0, 0), 0, 0));
  ...
  public void itemListenerAction(IItemType itemType, AWTEvent event) {
    ...
    if (itemType == importMode) {
      ...
      if (importModeUpd != null) {
        importModeUpd.setEnabled(mode.equals(DataImport.IMPORTMODE_UPD)
            || mode.equals(DataImport.IMPORTMODE_ADDUPD));
      }
