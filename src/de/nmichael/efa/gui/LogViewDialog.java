...
public class LogViewDialog extends BaseDialog {
  ...
  public LogViewDialog(Frame parent) {
    super(parent, International.getStringWithMnemonic("Logdatei"), International
        .getStringWithMnemonic("Schließen"));
  }
  ...
  protected void iniDialog() throws Exception {
    ...
    Mnemonics.setButton(this, artInfo, International.getStringWithMnemonic("Informationen") + " ("
        + Logger.INFO.trim() + ")");
    ...
    Mnemonics.setButton(this, artWarn, International.getStringWithMnemonic("Warnungen") + " ("
        + Logger.WARNING.trim() + ")");
    ...
    Mnemonics.setButton(this, artErr, International.getStringWithMnemonic("Fehler") + " ("
        + Logger.ERROR.trim() + ")");
    ...
    Mnemonics.setButton(this, artDbg, International.getStringWithMnemonic("Debug") + " ("
        + Logger.DEBUG.trim() + ")");
    ...
    filterPanel.add(jLabel1, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
        GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    filterPanel.add(zeitHeute, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    filterPanel.add(jLabel2, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    filterPanel.add(artInfo, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    filterPanel.add(zeit7Tage, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    filterPanel.add(zeitAlle, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    filterPanel.add(filterApplLabel, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0,
        GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    filterPanel.add(filterAppl, new GridBagConstraints(1, 3, 2, 1, 0.0, 0.0,
        GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    filterPanel.add(filterLabel, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0,
        GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    filterPanel.add(filter, new GridBagConstraints(1, 4, 3, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

    filterPanel.add(artWarn, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    filterPanel.add(artErr, new GridBagConstraints(3, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    filterPanel.add(artDbg, new GridBagConstraints(3, 3, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
        GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
