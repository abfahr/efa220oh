...
public class OnlineUpdateDialog extends BaseDialog {
  ...
  public OnlineUpdateDialog(JDialog parent, String newVersionName, String newVersionDate,
      long downloadSize, Vector<String> changes) {
    super(parent,
  ...
  protected void iniDialog() throws Exception {
    ...
    info.append("<p><b>"
        + International.getString("Änderungen gegenüber der installierten Version") + ":</b></p>");
    info.append("<ul>");
