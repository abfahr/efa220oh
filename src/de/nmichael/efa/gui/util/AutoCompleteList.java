...
public class AutoCompleteList {
    ...
    try {
      ...
      if (dataAccess != null &&
        ...
        for (DataKey k = it.getFirst(); k != null; k = it.getNext()) {
          ...
          if (r != null) {
            if (_searchId != null && r.getUniqueIdForRecord() != null
                && _searchId.equals(r.getUniqueIdForRecord().toString())) {
            ...
            if (r instanceof DestinationRecord) {
              ...
              if (!postfixNamesWithBoathouseName && myBoathouseName != null) {
                ...
                String dest = DestinationRecord
                    .getDestinationNameFromPostfixedDestinationBoathouseString(s);
                String bths = DestinationRecord
                    .getBoathouseNameFromPostfixedDestinationBoathouseString(s);
  ...
  private synchronized void addInternal(String s, String lowers,
      Hashtable<String, String> lower2real,
  ...
  public synchronized Object getId(String qname) {
    try {
      if (dataAccess != null && dataAccess.isStorageObjectOpen()) {
        ...
        DataKey[] keys = dataAccess.getByFields(dummyRec.getQualifiedNameFields(),
            dummyRec.getQualifiedNameValues(qname));
        if (keys == null || keys.length < 1) {
          return null;
        }
        for (DataKey key : keys) {
          DataRecord r = dataAccess.get(key);
   ...
   * EditDistance - number of keboard-hits to transform name into neighbour.
   *
  ...
  private static void addPermutation(Vector<String> perms, Vector<String> parts, String perm,
      int maxPermutations) {
