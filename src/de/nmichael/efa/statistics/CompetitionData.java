...
public class CompetitionData {
  ...
  public Hashtable<String, Long> etappen = new Hashtable<String, Long>(); // Etappenname(String) ->
  // Meter(Long)
  public int activeDays = 0; // Anzahl der gesamten Rudertage
  public Hashtable<UUID, Long> teilnMueber18 = new Hashtable<UUID, Long>(); // Teilnehmername(String)
  // -> Meter(Long)
  public Hashtable<UUID, Long> teilnMbis18 = new Hashtable<UUID, Long>(); // Teilnehmername(String)
  // -> Meter(Long)
  public Hashtable<UUID, Long> teilnFueber18 = new Hashtable<UUID, Long>(); // Teilnehmername(String)
  // -> Meter(Long)
  public Hashtable<UUID, Long> teilnFbis18 = new Hashtable<UUID, Long>(); // Teilnehmername(String)
  // -> Meter(Long)
  ...
  public Vector<LogbookRecord> gigfahrten = new Vector<LogbookRecord>(); // Vector of String[6] mit
  // LfdNr, Datum, Boot,
  // Ziel, Km, Bemerkungen
}
