...
public class FTPClient {
  ...
  public String getFile() {
    return (remoteDirectory != null && remoteFile != null ? remoteDirectory + "/" + remoteFile
        : null);
  }
  ...
  public static String getFtpStringGuiDialog(String s) {
    ...
    if (MultiInputDialog.showInputDialog((JDialog) null, International.getString("FTP-Upload"),
        items)) {
