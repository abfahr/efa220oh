  ...
  public String run() {
    ...
    try {
      ...
      try {
        ...
        org.apache.fop.apps.Fop fop = fopFactory.newFop(
            org.apache.xmlgraphics.util.MimeConstants.MIME_PDF, out);
        ...
        javax.xml.transform.Result result = new javax.xml.transform.sax.SAXResult(
        ...
        if (Logger.isTraceOn(Logger.TT_PDF, 1)) {
          Logger.log(Logger.DEBUG, Logger.MSG_DEBUG_PDF, "Successfully created " + pageCount
              + " Pages PDF.");
        }
      } catch (Exception e1) {
