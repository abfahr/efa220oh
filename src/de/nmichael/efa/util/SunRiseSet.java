...
public class SunRiseSet {
  ...
  public SunRiseSet() {
    uk.me.jstott.coordconv.LatitudeLongitude ll =
        new uk.me.jstott.coordconv.LatitudeLongitude(
            uk.me.jstott.coordconv.LatitudeLongitude.NORTH, 0, 0, 0,
  ...
  public static String[] getSunRiseSet(ItemTypeLongLat latitude, ItemTypeLongLat longitude)
      throws Exception {
